        ...
        <div className="all-location-list-section buy-gift bg-black relative overflow-hidden px-4 md:px-6">
          ...
          <div className="max-w-7xl mx-auto md:px-4 py-16 md:py-28">
            <div className="section-head relative z-20">
              <TitleSeparator
                title="All In Adventures COVID-19 Update"
                color="golden-text"
                weight="font-bold"
              />
            ...
            <div className="cov-content max-w-[990px] text-[#dddddd] bg-[#111111] mx-auto py-6 px-4 md:py-8 md:px-8">
              <p className="text-[#dddddd] lg:text-lg">
                ...
                patience while we work diligently to get back to some version of
                the new normal. At this point in time we have pretty much
                reopened all of our stores with REVISED hours of operation (see
                location page for specific hours of operation for a particular
                store). As we continue thru this process I want to reiterate
                that the health and safety of our customers and employees is our
                top priority. We are taking a very careful and thoughtful
                approach to reopening and have made many changes to our
                operations to ensure everyone feels safe and comfortable. Some
                of these changes include:
              </p>
              <ul className="star-list  pl-4 mt-8">
                <li className="my-2 md:my-3 lg:text-lg">
                  Allowing all PRIVATE room bookings to avoid playing with
                  people you don&apos;t know regardless of the size of your
                  group
                </li>
                <li className="my-2 md:my-3 lg:text-lg">
                ...
                <li className="my-2 md:my-3 lg:text-lg">
                  Customer&apos;s required to wear masks based on State and
                  Local mandated guidelines
                </li>
                <li className="my-2 md:my-3 lg:text-lg">
                  ...
                  {props.location ? (
                    <div className="game-btn-all ">
                      <Link href={"/" + props.location + "/activities/"}>
                        <a className="max-w-[260px] md:max-w-[280px] my-4 block mx-auto uppercase py-3 md:py-4 px-6 text-lg text-white font-medium border-2 border-red-600 hover:border-red-700 bg-red-600 hover:bg-red-700 rounded-full text-center">
                          VIEW ALL GAMES
                        </a>
                      </Link>
                      <Link href={"/" + props.location + "/events/"}>
                        <a className="max-w-[260px] md:max-w-[280px] my-4 block mx-auto uppercase py-3 md:py-4 px-6 text-lg text-[#424242] hover:text-white font-medium border-2 border-red-600 hover:border-red-700 hover:bg-red-700 rounded-full text-center">
                          VIEW ALL EVENTS
                        </a>
                      </Link>
                    </div>
                    ...
                    <div className="game-btn-all ">
                      ...
                      <Link href="/events/">
                        <a className="max-w-[260px] md:max-w-[280px] my-4 block mx-auto uppercase py-3 md:py-4 px-6 text-lg text-[#dddddd] hover:text-white font-medium border-2 border-red-600 hover:border-red-700 hover:bg-red-700 rounded-full text-center">
                          VIEW ALL EVENTS
                        </a>
                      </Link>
                    </div>
