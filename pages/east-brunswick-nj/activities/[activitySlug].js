    ...
    <>
      ...
      <div id="mainContent" className="main-content">
        ...
        <GameLocDetails
          ...
          activityname={props.pagedata.activityname}
        ...
        />
        <GameGallery
          galleryitem={props.activitygallery}
          activityname={props.pagedata.activityname}
          category={props.activitydata.category}
        />
        <GameVideo
          activityname={props.pagedata.activityname}
          videothumb={props.activitydata.videothumb}
          videoid={props.activitydata.videoid}
          location={props.pagedata.locationslug}
        />
...
export const getStaticPaths = async () => {
  const res = await getLocationActivitySlugList("east-brunswick-nj");
...
export const getStaticProps = async (context) => {
  const locationHomedata = getLocationSingleActivitypageData(
