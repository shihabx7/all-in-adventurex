...
const LocSingleActivity=(props)=>{
     ...
     return (
         <>
             ...
             <Footer  location="syracuse, ny" locationlist={props.locationlist} totallocations={props.pagedata.totalLocations}/>
         </>
...
export const getStaticPaths=async()=>{
  ...
  export const getStaticProps=async(context)=>{
   ...
   // routerSlug=routerSlug.split('-')
    ...
    const locationHomedata=getLocationSingleActivitypageData(context.params.activitySlug,"syracuse-ny")
