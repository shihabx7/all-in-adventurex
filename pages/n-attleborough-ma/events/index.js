         ...
         <Seofields meta={props.pagemeta}/>
             <Homenav locationslug={props.pagedata.locationslug}
                 ...
                 {/* =======header content and breadcum======== */}
                         ...
                         <EventList events={props.eventLocList} eventbooking={props.pagedata.eventbooking} locationslug="n-attleborough-ma"/>
...
export const getStaticProps=async(context)=>{
    ...
    const locationHomedata=getLocationsEventList("n-attleborough-ma")
