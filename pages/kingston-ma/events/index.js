         ...
         <>
             <Homenav locationslug={props.pagedata.locationslug}
                 ...
                 {/* =======header content and breadcum======== */}
                         ...
                         <EventList events={props.eventLocList} eventbooking={props.pagedata.eventbooking} locationslug="kingston-ma"/>
...
export const getStaticProps=async(context)=>{
   ...
   // routerSlug=routerSlug.split('-')
    ...
    const locationHomedata=getLocationsEventList("kingston-ma")
