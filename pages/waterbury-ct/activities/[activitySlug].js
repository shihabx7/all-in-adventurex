...
const LocSingleActivity=(props)=>{
     ...
     return (
         <>
             ...
             <Footer  location="waterbury, ct" locationlist={props.locationlist} totallocations={props.pagedata.totalLocations}/>
         </>
...
export const getStaticPaths=async()=>{
    const res= await getLocationActivitySlugList("waterbury-ct");
  ...
  export const getStaticProps=async(context)=>{
   ...
   // routerSlug=routerSlug.split('-')
    ...
    const locationHomedata=getLocationSingleActivitypageData(context.params.activitySlug,"waterbury-ct")
