         ...
         <Seofields meta={props.pagemeta}/>
             <Homenav locationslug={props.pagedata.locationslug}
                 ...
                 {/* =======header content and breadcum======== */}
                         ...
                         <EventList events={props.eventLocList} eventbooking={props.pagedata.eventbooking} locationslug="lawrenceville-ga"/>
                         
                         <EventContact contactdata={props.contactdata} locationlist={props.locationlist} eventlist={props.eventlist}/>
                        
                 </div>
 
             <Footer location="lawrenceville, ga" locationlist={props.locationlist} totallocations={props.pagedata.totalLocations}/>
         </>
...
export const getStaticProps=async(context)=>{
    ...
    const locationHomedata=getLocationsEventList("lawrenceville-ga")
