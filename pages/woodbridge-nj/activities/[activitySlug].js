         ...
         <>
             <Homenav locationslug={props.pagedata.locationslug} 
                 ...
                 {/* =======header content and breadcum======== */}
                        ...
                        <GameVideo videoid={props.activitydata.videoid} activityname={props.pagedata.activityname} location={props.pagedata.locationslug}/>
                        {
             ...
             <Footer  location="woodbridge, nj" locationlist={props.locationlist} totallocations={props.pagedata.totalLocations}/>
         </>
...
export const getStaticPaths=async()=>{
    const res= await getLocationActivitySlugList("woodbridge-nj");
  ...
  export const getStaticProps=async(context)=>{
   ...
   // routerSlug=routerSlug.split('-')
    ...
    const locationHomedata=getLocationSingleActivitypageData(context.params.activitySlug,"woodbridge-nj")
