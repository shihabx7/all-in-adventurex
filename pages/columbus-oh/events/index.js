         ...
         <>
             <Homenav locationslug={props.pagedata.locationslug}
                 ...
                 {/* =======header content and breadcum======== */}
                         ...
                         <EventList events={props.eventLocList} locationslug="columbus-oh" eventbooking={props.pagedata.eventbooking}/>
                         
                         <EventContact contactdata={props.contactdata} locationlist={props.locationlist} eventlist={props.eventlist}/>
                        
                 </div>
 
             <Footer location="columbus, oh" locationlist={props.locationlist} totallocations={props.pagedata.totalLocations}/>
         </>
...
export const getStaticProps=async(context)=>{
   ...
   // routerSlug=routerSlug.split('-')
    ...
    const locationHomedata=getLocationsEventList("columbus-oh")
