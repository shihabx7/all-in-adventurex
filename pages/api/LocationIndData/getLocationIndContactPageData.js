...
export const getLocationIndContactPageData = (locationslug) => {
  ...
  const contactPageData = {
    pagemeta: {
      ...
      description:
        "Our team is here to help you. Contact our store in " +
        capCity(locationslug) +
        " at " +
        capMall(getLocSpec(locationslug).mall) +
        " with any questions you have about an upcoming or previous experience.",
      keywords:
        "all in adventures albany ny, allinadventures " +
        ...
        ",escape room near by " +
        lowCity(locationslug) +
        ", escape room albany ny, escaperoom " +
        lowCity(locationslug) +
        ", escape games " +
        lowCity(locationslug) +
        ", escapegames " +
    ...
    pagedata: {
      pagetitle:
        "CONTACT ALL IN ADVENTURES " + locnameMod(locationslug) + " STORE",
      pagesubtitle:
        'Our team is here to help you. Contact us with any questions you have about an upcoming or previous experience. Before reaching out, we recommend you check our <a href="/faqs" class="text-red-600 font-medium hover:text-red-700">FAQs</a> page first to see if your question has been answered.',
      ...
      coverimageM:
        "/assets/gn-mobile-hero/allinadventures-store-contact-hero.jpg",

      bookingall: {
        shortname: bookinData.shortname,
        flow: bookinData.flow,
      },
      eventbooking: {
        shortname: bookinData.shortname,
