...
export const getGalleryPageData = async () => {
  ...
  const data = {
    ...
    pageMeta: {
      ...
      description:
        "Look at some fun-filled photos of our customers after their escape room and other gaming experiences at All In Adventures (formerly Mystery Room).",
      keywords:
        "escape room customers, escape room players, escape room groups, all in adventures customers, all in adventures players, all in adventures groups, mystery room customers, mystery room players, mystery room groups, escape game customers, escape game players, escape game groups",
      url: "/gallery",
      metaindex: true,
      metaimg:
        "/assets/gn-mobile-hero/allinadventures-customer-gallery-hero.jpg",
    },
    ...
    pageData: {
      ...
      coverimageL:
        "/assets/gn-desktop-hero/allinadventures-customer-gallery-hero.jpg",
      coverimageM:
        "/assets/gn-mobile-hero/allinadventures-customer-gallery-hero.jpg",
      totalLocations: totalLocations,
    },
