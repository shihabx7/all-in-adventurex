...
export const getActivityData = (activitySlug) => {
  ...
  const activityData = {
    ...
    pagedata: {
      ...
      groupcat: activityDataset[activitySlug].groupcat
        ? activityDataset[activitySlug].groupcat
        : "",
      ...
      age: activityDataset[activitySlug].age
        ? activityDataset[activitySlug].age
        : false,
      ...
      activityname: activityDataset[activitySlug].shortname
        ...
        : activityDataset[activitySlug].activityname,
      notice: activityDataset[activitySlug].notice
        ? activityDataset[activitySlug].notice
        : false,
    },
...
const activityDataset = {
  ...
  "escape-from-alcatraz": {
    ...
    pagemeta: {
      ...
      description:
        "You are prison guards at the maximum security prison, Alcatraz. The Warden's keys have gone missing! Find them or they'll escape.",
      keywords:
        "escape from alcatraz, escape from alcatraz escape room, all in adventure escape from alcatraz, mystery room escape from alcatraz,  alcatraz escape room, prison break escape room, prison break escape room near me, jail break escape room, escape from alcatraz escape room near me, prison themed escape room, escape alcatraz escape room, escape from alcatraz escape game",
  ...
  "treasure-island": {
    ...
    pagemeta: {
      ...
      description:
        "You've been captured by a notorious gang of pirates. Prove you're worthy of becoming part of the crew or prepare to walk the plank!",
      keywords:
        "treasure island, treasure island escape room, all in adventures treasure island, mystery room treasure island, treasure pirate escape room, treasure escape room, treasure escape game, pirate escape game, treasure island escape room near me, pirate escape room, pirate themed escape room, treasure hunt escape room, treasure island escape game,",
  ...
  "superheros-adventure": {
    ...
    themeImageAlt: "Comic book heroes escape room theme",
    pagesubtitle:
  ...
  "zombie-apocalypse": {
    ...
    pagemeta: {
      ...
      keywords:
        "zombie apocalypse, zombie apocalypse escape room, zombie apocalypse mystery room, mystery room zombie escape room, all in adventure zombie apocalypse, zombie escape room, escape room zombie, zombie apocalypse escape room near me, zombie escape room near me, escape room zombie near me, zombie theme escape room, zombie escape game,  scary escape room, horror escape room",
  ...
  "hollywood-premiere": {
    ...
    pagemeta: {
      ...
      description:
        "Live from Hollywood, California. You're the next lucky contestant on our exciting game show! To win the game, name our secret celebrity!",
      keywords:
        "hollywood premiere escape room, hollywood escape room, hollywood premiere mystery room, all in adventure hollywood premiere, hollywood theme escape room, hollywood celebrity escape room, hollywood premiere mystery room, hollywood mystery escape room, hollywood premiere escape room near me, hollywood escape room near me, hollywood theme escape room near me, hollywood celebrity escape room near me, hollywood premiere mystery room near me, hollywood mystery escape room near me",
  ...
  "houdinis-magic-cell": {
    ...
    pagemeta: {
      ...
      description:
        "As an aspiring magician, you have always looked up to Houdini and his impressive skills. Now, it is your chance to prove you are better!",
      keywords:
        "houdinis magic cell, houdinis magic cell escape room, all in adventure houdini magic cell, mystery room houdinis magic cell, houdini escape room, magic theme escape room, magician escape room, houdinis magic cell mystery room, houdinis magic cell escape room near me, houdini escape room near me, magic theme escape room near me, magician escape room near me, houdinis magic cell mystery room near me,",
  ...
  "black-ops": {
    ...
    pagemeta: {
      ...
      description:
        "After acquiring all necessary evidence, it is time to execute your mission. Infiltrate the enemy bunker and apprehend the arms dealer!",
      keywords:
        "black ops, black ops escape room, all in adventure black ops, black ops mystery room, action escape room, war theme escape room, black ops escape game, black ops mystery room, black ops escape room near me, action escape room near me, war theme escape room near me, black ops escape game near me, black ops mystery room near me",
  ...
  "lost-in-the-jungle": {
    ...
    pagemeta: {
      ...
      description:
        "After hearing some strange noises on your roof, you decide to investigate. Your future is dependent on learning more about the strange noises!",
      keywords:
        "lost in jungle escape room, adventure jungle escape room, jungle theme escape room, lost in the jungle mystery room, lost in jungle escape room near me, adventure jungle escape room near me, jungle theme escape room near me, lost in the jungle mystery room, all in adventure lost in the jungle",
  ...
  "wizarding-school": {
    ...
    pagemeta: {
      ...
      keywords:
        "wizarding school escape room, wizard escape room, wizarding escape room, wizarding school mystery room, wizarding school escape room near me, wizard escape room near me, wizarding escape room near me, wizarding school mystery room, all in adventure wizarding school",
  ...
  /*"magic-castle": {
   ...
   themeImage:
    ...
    pagemeta: {
      ...
      description:
        "Welcome to the Magic Castle! Pass your entrance exam to prove you belong among the most prestigious wizards. But it's not easy!",
      keywords:
        "magic castle escape room, magic escape room, magic castle escape game, magic castle mystery room, magic castle escape room near me, magic escape room near me, magic castle escape game near me, magic castle mystery room, all in adventure magic castle,",
  ...
  /* "locked-in-the-lift": {
   ...
   themeImage:
    ...
    pagemeta: {
      ...
      description:
        "Welcome to the 40's! You are trapped in a luxurious lift meant only for the most exclusive VIPs. Act fast and save yourself and others!",
      keywords:
        "locked in the lift escape room, locked escape room, locked in the lift escape game, locked in the lift mystery room, locked in the lift escape room near me, locked escape room near me, locked in the lift escape game near me, locked in the lift mystery room, all in adventure locked in the lift",
