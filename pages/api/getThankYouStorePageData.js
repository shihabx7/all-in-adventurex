...
export const getThankYouStorePageData = async () => {
  ...
  // fetch page data
  const reqUrl =
    thanYouPagesQuery + thankYouSeoQueryBuilder("storeThankYouSeo");
  ...
  const seoData = pageResData.storeThankYouSeo;
  ...
  const data = {
    ...
    pageMeta: getThankYouPageMeta(seoData, "thank-you-store"),
