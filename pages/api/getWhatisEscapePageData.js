...
import { whatisErPageQuery } from "../../lib/query/singlePageQury";
import {
  getLocationSlugList,
...
export const getWhatisEscapePageData = async () => {
  ...
  const pegeRes = await fetch(whatisErPageQuery, apiSetting);
  ...
  const data = {
    ...
    pageMeta: getSinglePageMeta(seoData, ftImage, "what-is-an-escape-room"),
