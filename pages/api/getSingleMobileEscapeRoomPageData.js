...
import { singleMobileEscapePageData } from "../../lib/tempData/mobileEscapeTempData";

export const getSingleMobileEscapeRoomPageData = async (smerslug) => {
  ...
  const Data = {
    ...
    pageMeta: singleMobileEscapePageData[smerslug].pageMeta,
    mobileEscapeRoomPageData: singleMobileEscapePageData[smerslug],
  };
