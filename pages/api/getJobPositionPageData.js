...
const jobData = {
  associate: {
    coverimageL:
      "/assets/gn-desktop-hero/allinadventures-career-associate-hero.jpg",
    coverimageM:
      "/assets/gn-mobile-hero/allinadventures-career-associate-hero.jpg",
    pagesubtitle:
      "This is a great opportunity for anyone excited for the chance to grow and develop with a startup company that is looking to change the face of how people interact socially through live games and activities.",
    pagemeta: {
      title: "Apply For Associate Position | All In Adventures",
      description:
        "This is a great opportunity for anyone excited for the chance to grow and develop with a startup company. Apply today!",
      keywords:
        "all in adventures careers, all in adventures jobs, all in adventures associate",
    ...
    desired_traits: [
      {
        id: 1,
        trait:
          "No clue or puzzle solving experience necessary, but previous sales, customer service, guest service, hospitality, theme park, retail or restaurant experience a plus.",
      },
      {
        id: 2,
        trait:
          "Training will be provided to all new hires. You just need a positive attitude, a willingness to provide outstanding guest service, and a desire to succeed.",
      },
    ],
    requirements: [
      {
      ...
      },
      {
        id: 3,
        requirement:
          "May be required to pass company background screen and reference check",
      },
      {
        id: 4,
        requirement:
  ...
  "store-lead": {
    coverimageL:
      "/assets/gn-desktop-hero/allinadventures-career-store-lead-hero.jpg",
    coverimageM:
      "/assets/gn-mobile-hero/allinadventures-career-store-lead-hero.jpg",
    pagesubtitle:
      "This is a great opportunity for anyone excited for the chance to grow and develop with a startup company that is looking to change the face of how people.",
    pagemeta: {
      title: "Apply For Store Lead Position | All In Adventures",
      description:
        "This is a great opportunity for anyone excited for the chance to grow and develop with a startup company. Apply today!",
      keywords:
        "all in adventures careers, all in adventures jobs, all in adventures store lead,",
    ...
    requirements: [
      {
        id: 1,
        requirement:
          "High School diploma or equivalent 1 year of previous supervisor or management experience",
      },
      {
        id: 2,
      ...
      },
      {
        id: 4,
        requirement:
          "Able to work a flexible schedule (30 - 40 hrs/wk), including nights, weekends and holidays",
      },
      {
        id: 5,
        requirement: "Must have reliable transportation",
      ...
      },
      {
        id: 9,
        requirement:
          "Ability to adapt to a fast-paced work environmentProficiency with Microsoft Office tools",
      },
      {
        id: 10,
  ...
  "assistant-manager": {
    coverimageL:
      "/assets/gn-desktop-hero/allinadventures-career-assistant-manager-hero.jpg",
    coverimageM:
      "/assets/gn-mobile-hero/allinadventures-career-assistant-manager-hero.jpg",
    pagesubtitle:
      "This is a great opportunity for anyone excited for the chance to grow and develop with a startup company that is looking to change the face of how people.",
    pagemeta: {
      ...
      description:
        "This is a great opportunity for anyone excited for the chance to grow and develop with a startup company. Apply today!",
      keywords:
        "all in adventures careers, all in adventures jobs, all in adventures assistant manager",
  ...
  "store-manager": {
    coverimageL:
      "/assets/gn-desktop-hero/allinadventures-career-store-manager-hero.jpg",
    coverimageM:
      "/assets/gn-mobile-hero/allinadventures-career-store-manager-hero.jpg",
    pagesubtitle:
      "This is a great opportunity for anyone excited for the chance to grow and develop with a startup company that is looking to change the face of how people.",
    pagemeta: {
      ...
      description:
        "This is a great opportunity for anyone excited for the chance to grow and develop with a startup company. Apply today!",
      keywords:
        "all in adventures careers, all in adventures jobs, all in adventures store manager",
    ...
    desired_traits: [
      {
        id: 1,
        trait:
          "Previous supervisory or sales management, retail management, hospitality management, event management, restaurant management experience a plus.",
      },
      {
        id: 2,
        trait:
          "Training will be provided to all new hires. (The flexibility to travel to a nearby training store for one week is required.)",
      },
      {
        id: 3,
        trait:
          "We’re eager to talk to you if you possess a positive attitude, the enthusiasm and energy to inspire others to do their very best, and a desire to grow and succeed with an exciting new company",
      },
    ],
    requirements: [
      {
        id: 1,
        requirement:
          "High School diploma (college degree preferred) 3 years of previous supervisor or management experience",
      },
      {
        id: 2,
        requirement: "Able to lift up to 50lbs",
