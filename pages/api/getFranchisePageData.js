...
import { franchisePageQuery } from "../../lib/query/singlePageQury";
import {
  getLocationSlugList,
...
export const getFranchisePageData = async () => {
  ...
  // fetch page data
  const pegeRes = await fetch(franchisePageQuery, apiSetting);
  ...
  const data = {
    ...
    pageMeta: getSinglePageMeta(seoData, ftImage, "franchise"),
