...
import { faqPageQurey } from "../../lib/query/singlePageQury";
import {
  getSinglePageMeta,
  getSinglePageData,
...
export const getFaqPageData = async () => {
  ...
  const pegeRes = await fetch(faqPageQurey, apiSetting);
  ...
  const data = {
    ...
    pageMeta: getSinglePageMeta(seoData, ftImage, "faqs"),

    pageData: getSinglePageData(pageResData, totalLocations),
    faqGroup: pageResData.faqGroup,
  };
...
/*const oldData = {
  ...
  pageMeta: {
    ...
    keywords:
      "escape room faqs, escape room faq, escape room frequently asked questions, all in adventures faqs, all in adventures faq, all in adventures frequently asked questions, mystery room faqs, mystery room faq, mystery room frequently asked questions,",
    url: "/faqs",
    metaindex: true,
  ...
  pageData: {
    ...
    pagesubtitle:
      "Have you ever wished, just for a moment, you could live inside an adventure movie? Want to be the hero that solves the mystery or saves the world? Well, now you can! Book your adventures today! ",
  ...
  faqlist: [
    // ---- getting started=======
    {
      ...
      ans: [
        "We clean and disinfect high-touch surfaces daily in our games and lobby. ",
    ...
    },
    {
      ...
      ans: ["Most escape rooms are 50-60-minutes in length."],
    },
    {
      id: 29,
      category: "escape",
