...
import { answersPageQuery } from "../../lib/query/singlePageQury";
import {
  getLocationSlugList,
...
export const getAnswerPageData = async () => {
  ...
  const pegeRes = await fetch(answersPageQuery, apiSetting);
  ...
  const ansdata = {
    ...
    pageMeta: getSinglePageMeta(seoData, ftImage, "answers"),

    pageData: getSinglePageData(pageResData, totalLocations),
    hintList: pageResData.options,
  };
