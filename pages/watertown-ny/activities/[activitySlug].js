...
const LocSingleActivity=(props)=>{
     ...
     return (
         <>
             ...
             <Footer  location="watertown, ny" locationlist={props.locationlist} totallocations={props.pagedata.totalLocations}/>
         </>
...
export const getStaticPaths=async()=>{
    const res= await getLocationActivitySlugList("watertown-ny");
  ...
  export const getStaticProps=async(context)=>{
   ...
   // routerSlug=routerSlug.split('-')
    ...
    const locationHomedata=getLocationSingleActivitypageData(context.params.activitySlug,"watertown-ny")
