...
const Locations = (props) => {
  ...
  return (
    <>
          ...
          <div className="max-w-7xl mx-auto py-16 md:py-16 px-4 relative z-10">
            <div className="page-benar-info">
              ...
              <p className="text-gray-700 max-w-[800px] mx-auto text-center lg:text-lg">
                Browse all our escape room adventure centers across the United
                States. Grab your team today and head over to any of our
                locations to experience family and kids friendly interactive fun
                activities that you and your team will never forget!
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto md:px-4 py-16 md:py-28">
            <div className="section-head relative z-20">
              ...
              <div className="max-w-[800px] md:text-lg mx-auto text-center mt-4 md:mt-8 mb-10 md:mb-12 lg:mb-16">
                <p className="text-gray-300 md:px-8">
                  We can cater to a minimum of 2 players, and our facility can
                  host private parties and corporate events for up to 75 players
                  at a time. Our escape rooms and other games are perfect for
                  all ages and skill levels, so everyone can have fun and be
              ...
              <div className="loc-list-tab mx-auto mb-4 md:mb-6 lg:mb-8 ">
                <div className="flex">
                  <div className="all-list">
                    <button
                      onClick={() => setShowLoclist("ALL")}
                      className=" min-w-[98px] md:min-w-[112px] bg-red-600 hover:bg-red-700 focus:bg-red-700 focus:border-red-700 py-3 px-2 md:py-3 md:px-2 text-sm md:text-base lg:text-lg text-white rounded-l border border-red-600"
                    >
                      ALL<span> ({countTotalLocation(props.states)})</span>
                    </button>
                  </div>
                  <div
                    id="loc-tab-list-box"
                  ...
                  >
                    <div
                      id="loc-tab-list"
                      className="loc-tab-list flex space-x-[1px] "
                    >
                      {props.states.map((state) => {
                        return (
                          <button
                            ...
                            className="bg-[#1c1c1c] hover:text-gold hover:bg-[#111] focus:text-gold focus:bg-[#111] py-3 px-1 md:px-1 text-sm md:text-base lg:text-lg text-[#7b7b7b] min-w-[96px] md:min-w-[102px]"
                          >
                            {state.state}
                            <span> ({state.cities.length})</span>
                          </button>
                        );
                      })}
                    </div>
      ...
      <Footer
        locationlist={props.states}
        totallocations={countTotalLocation(props.states)}
      />
    </>
  );
};
