         ...
         <>
             <Homenav locationslug={props.pagedata.locationslug}
                 ...
                 {/* =======header content and breadcum======== */}
                         ...
                         <EventList events={props.eventLocList}  eventbooking={props.pagedata.eventbooking} locationslug="rockaway-nj"/>
                         
                         <EventContact contactdata={props.contactdata} locationlist={props.locationlist} eventlist={props.eventlist}/>
                        
                 </div>
 
             <Footer location="rockaway, nj" locationlist={props.locationlist} totallocations={props.pagedata.totalLocations}/>
         </>
...
export const getStaticProps=async(context)=>{
   ...
   // routerSlug=routerSlug.split('-')
    ...
    const locationHomedata=getLocationsEventList("rockaway-nj")
