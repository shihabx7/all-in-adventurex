         ...
         <Seofields meta={props.pagemeta}/>
             <Homenav locationslug={props.pagedata.locationslug}
                 ...
                 {/* =======header content and breadcum======== */}
                         ...
                         <EventList events={props.eventLocList} eventbooking={props.pagedata.eventbooking}  locationslug="holyoke-ma"/>
...
export const getStaticProps=async(context)=>{
    ...
    const locationHomedata=getLocationsEventList("holyoke-ma")
