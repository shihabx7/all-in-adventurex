    ...
    <>
      ...
      >
        <div className="home-hero-holder pt-0 pb-24 rm:pb-28  xm:pb-28 md:py-24 lg:py-32 2xl:py-36  relative">
          ...
          {/* shadow */}
          <div className="max-w-7xl home-hero-containerx mx-auto mt-[-28%] rm:mt-[-26%] lm:mt-[-25%] zm:mt-[-24%] sm:mt-[-22%] md:mt-0 md:pt-[20px] lg:pt-0 relative px-4  z-20">
          ...
          <div className="game-ft drop-shadow-[0_4px_8px_rgba(216,174,84,0.45)] max-w-[95%]  xm:max-w-[92%] mx-auto md:max-w-3xl absolute bottom-[-18%] rm:bottom-[-17%] lm:bottom-[-16%] zm:bottom-[-15%] sm:bottom-[-14%] md:bottom-[-13%] left-0 right-0  bg-white px-2 py-4 md:py-4 md:px-4 lg:py-6  rounded z-40">
...
export default EventLocListHero;
