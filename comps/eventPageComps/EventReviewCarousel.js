...
const EventReviewCarousel = ({ testimonialData }) => {
  const showLocation = () => {
              ...
              <div className="card-container relative">
                <div className="rev-card-head">
                  <div className="card-img review-img px-4">
                    <img src={data.revImage.url} alt={data.revImage.alt}></img>
                  </div>
                </div>
                  ...
                  <div className="card-rev-desc text-center">
                    <div className="card-rev-desc text-center min-h-[200px]">
                      ...
                      <p className="vx text-gold font-light lg:text-lg italic h-[130px] md:h-[172px]">
                        {showDescription(data.revText)}
                      </p>
                    </div>
                  </div>
                  <div className="card-rev-auth mt-4 pb-8 text-center">
                    <p className="text-[#afafaf] mt-4">{data.revAuthor}</p>

                    <p className="text-[#585858]">{data.revAuthorAddress}</p>
                  </div>
                </div>
              </div>
            </div>
...
export default EventReviewCarousel;
