...
const UseFullLinks=(props)=>{
    ...
    return(
        ...
        <div className='usefull-link  inline-block px-3 md:px-0 py-1 md:py-2 lg:py-2'> 
            <Link href="/locations"> 
                <a className='text-gray-400  text-sm  lg:text-base'>All Locations</a>
            </Link>
        </div>
        ...
        <div className='usefull-link inline-block px-3 md:px-0 py-1 md:py-2 lg:py-2'> 

         {
            ...
            } 
            {
                ...
                <a className='text-gray-400 text-sm  lg:text-base'>Other Games</a>
            </Link>
            }
        ...
        <div className='usefull-link inline-block px-3 md:px-0  py-1 md:py-2 lg:py-2'> 
            <Link href="/deals-coupons"> 
                <a className='text-gray-400 text-sm  lg:text-base'>Deals</a>
            </Link>
        </div>
        <div className=' hidden lg:block text-gray-400 text-2xl'> 
            <span className='block w-1 h-1 rounded-full bg-gray-400'></span>
