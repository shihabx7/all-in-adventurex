      ...
      <div className="max-w-[1000px] mx-auto py-20 px-4 md:py-24 lg:py-28 relative z-10">
        {props.hintList.map((item, index) => {
          return (
            <div
              key={index + 1}
              className="hint-box border-[1px] border-[#DAC89F] my-6 md:my-8 lg:my-12"
            >
              ...
              <div className="hint-ans-box">
                <div
                  ...
                  className="bg-[#FFF3D8] px-4 py-3 lg:px-6 lg:py-4 flex justify-between items-center"
                >
                  <p className="text-[#464646] text-lg lg:text-xl">Answer</p>{" "}
                  <p className="text-gold text-xl lg:text-3xl">
                    {showAns == item.id ? <FiChevronUp /> : <FiChevronDown />}
                  </p>
                </div>
                {showAns == item.id && (
                  <div className="hint-text bg-[#E3D2AA] px-4 py-3 lg:px-6 lg:py-4 border-t-[1px] border-[#71541A]">
