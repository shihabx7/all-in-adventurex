...
const Howtobook = () => {
  ...
  return (
    <>
      ...
      <div
        className="htb relative py-16 md:py-20 lg:py-28 px-4 overflow-hidden"
        style={{
          backgroundImage:
          ...
          <div className="hbt-container pt-4 md:pt-16 relative z-20">
            ...
            <div className="max-w-[800px] md:text-lg mx-auto text-center mt-4 md:mt-8 mb-10 md:mb-12 lg:mb-16">
              <p className="text-gray-700 md:px-8">
                ...
                large group of more than 10, or are you planning a big event?
                Contact your local store and let us help get you set up with
                special deals.
              </p>
            </div>
            {/* How to book 3 steps */}
