    ...
    return (<div className="vr-slider bg-black relative pb-16 md:pb-24 lg:pb-28 z-20" style={
      {
       ...
       <div className="view-all flex justify-center pt-8 md:pt-12 lg:pt-16">
              ...
              <a href="/virtual-games/" className="flex lg:text-lg justify-center space-x-2 items-center text-red-500 hover:text-red-700"><span>View all virtual / remote games</span> <FaAngleRight/></a>
