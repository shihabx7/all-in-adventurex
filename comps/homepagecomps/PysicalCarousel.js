...
const PysicalCarousel=()=>{
   ...
   >
     ...
     <div className="text-white bg-gray-300 game-slider-card card-border" style={{
       background:"url('/assets/py-game-1.jpg')"
     }}>
       <div className="card-container">
           ...
           <div className="card-bottom p-4 pt-12"> 
               <div className="card-game-desc text-center">
                   <h3 className="card-game-title text-2xl lg:text-3xl font-bold uppercase text-white">beat the seat</h3>
      ...
      {/*====== slide 2========= */}
     <div className="text-white bg-gray-300 game-slider-card card-border" style={{
       background:"url('/assets/py-game-2.jpg')"
     }}>
       <div className="card-container">
           <div className="card-head flex justify-between items-center p-4 pb-8">
               <div className="card-info">
           ...
           <div className="card-bottom p-4 pt-12"> 
               <div className="card-game-desc text-center">
                   <h3 className="card-game-title text-2xl lg:text-3xl font-bold uppercase text-white">game show room</h3>
                   <p className="text-gray-200 lg:text-lg">Select the number of participants fill out the details. fill out the number of details.</p>
               </div>
               <div className="card-game-link mt-4 text-center">
      ...
      {/*====== slide 3========= */}
      <div className="text-white bg-gray-300 game-slider-card card-border" style={{
       background:"url('/assets/py-game-3.jpg')"
     }}>
       <div className="card-container">
           <div className="card-head flex justify-between items-center p-4 pb-8">
               <div className="card-info">
           ...
           <div className="card-bottom p-4 pt-12"> 
               <div className="card-game-desc text-center">
                   <h3 className="card-game-title text-2xl lg:text-3xl font-bold uppercase text-white">axe throwing</h3>
                   <p className="text-gray-200 lg:text-lg">Select the number of participants fill out the details. fill out the number of details.</p>
               </div>
               <div className="card-game-link mt-4 text-center">
