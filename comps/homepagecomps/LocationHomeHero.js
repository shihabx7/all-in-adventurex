        ...
        <div className="homehero-img md:hidden">
            ...
            <div className='max-w-7xl home-hero-container mx-auto px-4 pb-16 pt-16 md:pb-24 md:pt-[160px] lg:pb-28 lg:pt-[210px] relative z-10'>
                <div className="page-benar-info"> 
                 ...
                 <h1 className='golden-text font-bold text-center text-3xl md:text-4xl lg:text-5xl mb-8 font-os uppercase max-w-[1000px] mx-auto'>ESCAPE ROOM AND FUN THINGS TO DO IN {props.pagedata.locationcity} {props.pagedata.locationstate}</h1>
