        ...
        <div className="homehero-img md:hidden w-full min-h-[280px] bg-[#000000]">
            ...
            <div className='max-w-7xl home-hero-container mx-auto px-4 pb-16 pt-0 md:pb-24 md:pt-[160px] lg:pb-28 lg:pt-[210px] relative z-10'>
                <div className="page-benar-info"> 
                 ...
                 <h1 className='text-gold font-bold text-center text-3xl md:text-5xl lg:text-6xl mb-4 md:mb-8 font-os uppercase max-w-[1000px] mx-auto'>ESCAPE ROOMS AND FUN THINGS TO DO IN {props.pagedata.locationcity}, {props.pagedata.locationstate}</h1>
