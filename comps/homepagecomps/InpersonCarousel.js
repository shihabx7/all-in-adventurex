       ...
       <div className="card-container">
           ...
           <div className="card-bottom p-4 pt-12"> 
               ...
               <div className="card-game-link mt-4 text-center">
                   <button className="border card-book-btn block mx-auto border-red-600 bg-red-600 py-3 px-12 rounded-full font-medium text-lg mb-4 hover:bg-red-700 hover:border-red-700">BOOK NOW</button>
                   <button className="border block mx-auto  border-red-600 bg-transparent py-3 px-10 rounded-full font-medium text-lg mb-2 hover:bg-red-700 hover:border-red-700">LEARN MORE</button>
               </div>
     ...
     <div className="text-white bg-gray-300 game-slider-card card-border" style={{
       ...
       <div className="card-container">
           ...
           <div className="card-bottom p-4 pt-12"> 
               ...
               <div className="card-game-link mt-4 text-center">
                   <button className="border block card-book-btn  mx-auto card-book-btn border-red-600 bg-red-600 py-3 px-12 rounded-full font-medium text-lg mb-4 hover:bg-red-700 hover:border-red-700">BOOK NOW</button>
                   <button className="border block mx-auto  border-red-600 bg-transparent py-3 px-10 rounded-full font-medium text-lg mb-2 hover:bg-red-700 hover:border-red-700">LEARN MORE</button>
               </div>
      ...
      <div className="text-white bg-gray-300 game-slider-card card-border" style={{
       ...
       <div className="card-container">
           ...
           <div className="card-bottom p-4 pt-12"> 
               ...
               <div className="card-game-link mt-4 text-center">
                   <button className="border block card-book-btn  mx-auto border-red-600 bg-red-600 py-3 px-12 rounded-full font-medium text-lg mb-4 hover:bg-red-700 hover:border-red-700">BOOK NOW</button>
                   <button className="border block mx-auto  border-red-600 bg-transparent py-3 px-10 rounded-full font-medium text-lg mb-2 hover:bg-red-700 hover:border-red-700">LEARN MORE</button>
               </div>
