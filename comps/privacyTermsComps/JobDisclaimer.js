                            ...
                            <div className="privacy-content-box max-w-[1040px] mx-auto">
                                ...
                                <div className="privacy-content">
                                      ...
                                      <p className="lg:text-lg text-gray-800 mt-2 md:mt-3 lg:mt-4">
                                         I certify that all information I have provided on this application is true,
                                        ...
                                        or immediately discharge me from employment when discovered.
                                     </p>
                                     <p className="lg:text-lg text-gray-800 mt-2 md:mt-3 lg:mt-4">
                                                I expressly authorize, without reservation,
                                                ...
                                                other persons, corporations or organizations for furnishing such information about me.
                                     </p>
                                     <p className="lg:text-lg text-gray-800 mt-2 md:mt-3 lg:mt-4">
                                            I understand that All in Adventures LLC. does not unlawfully discriminate in employment and no question on this application is used for purposes of limiting or excusing any applicant from consideration for employment on a basis prohibited by applicable local, 
                                            ...
                                            writing signed by me and an authorized representative of All in Adventures LLC.
                                     </p>
                                     <p className="lg:text-lg text-gray-800 mt-2 md:mt-3 lg:mt-4">
                                 ...
                                 <a href="/careers/apply" className="w-[280px] mx-auto md:mx-1  md:w-[300px] my-2 uppercase py-2 md:py-3   text-lg text-white font-medium border-2 border-red-600 hover:border-red-700 bg-red-600 hover:bg-red-700 rounded-full text-center">APPLY NOW</a>
                                 <a href="/careers/apply" className="w-[280px] mx-auto md:mx-1md:w-[300px] my-2 uppercase py-2 md:py-3  text-lg text-[#464646] hover:text-white font-medium border-2 border-red-600 hover:border-red-700 bg-transparent hover:bg-red-700 rounded-full text-center">APPLY NOW</a>
                                 </div>
