                                ...
                                <div className="wcp-list-box w-full md:w-[47%] lg:w-[42%]"> 
                                        <div className="wcp-list flex items-center mb-6 md:mb-8 lg:mb-10">
                                            ...
                                            <div className="wcp-list-text uppercase  py-3 md:py-4  px-4 md:px-6 lg:px-8 bg-[#111111] rounded w-full"> 
                                                 <p className="golden-text text-lg lg:text-xl">EDUCATIONAL INSTITUTIONS</p>
                                            </div>
                                        </div>
                                        <div className="wcp-list flex items-center mb-6 md:mb-8 lg:mb-10">
                                            <div className="flex justify-center items-center wcp-list-icon p-4 rounded bg-golden">
                                            ...
                                            <div className="wcp-list-text uppercase  py-3 md:py-4  px-4 md:px-6 lg:px-8 bg-[#111111] rounded w-full"> 
                                                 <p className="golden-text text-lg lg:text-xl">ANIMAL WELFARE ORGANIZATIONS</p>
                                            </div>
                                        </div>
                                        <div className="wcp-list flex items-center mb-6 md:mb-0">
                                            ...
                                            <div className="wcp-list-text uppercase  py-3 md:py-4  px-4 md:px-6 lg:px-8 bg-[#111111] rounded w-full"> 
                                                 <p className="golden-text text-lg lg:text-xl">PLANET SAVING AGENCIES</p>
                                            </div>
                                        </div>
                                </div>
                                <div className="wcp-list-box w-full md:w-[47%] lg:w-[42%]"> 
                                         <div className="wcp-list flex items-center mb-6 md:mb-8 lg:mb-10">
                                            ...
                                            <div className="wcp-list-text uppercase  py-3 md:py-4  px-4 md:px-6 lg:px-8 bg-[#111111] rounded w-full"> 
                                                 <p className="golden-text text-lg lg:text-xl">MEDICAL ORGANIZATIONS</p>
                                            </div>
                                        </div>
                                        <div className="wcp-list flex items-center mb-6 md:mb-8 lg:mb-10">
                                            <div className="flex justify-center items-center wcp-list-icon p-4 rounded bg-golden ">
                                            ...
                                            <div className="wcp-list-text uppercase  py-3 md:py-4  px-4 md:px-6 lg:px-8 bg-[#111111] rounded w-full"> 
                                                 <p className="golden-text text-lg lg:text-xl">YOUTH-FOCUSED ORGANIZATIONS</p>
                                            </div>
                                        </div>
                                        <div className="wcp-list flex items-center mb-0">
                                            ...
                                            <div className="wcp-list-text uppercase  py-3 md:py-4  px-4 md:px-6 lg:px-8 bg-[#111111] rounded w-full"> 
                                                 <p className="golden-text  md:text-lg lg:text-xl">LOCAL LAW ENFORCEMENT</p>
                                            </div>
                                        </div>
                                </div>
                            </div>
