...
const VolunteeringLoc=(props)=>{
   
       const closelocmenu=()=>{
     
        document.getElementById('volunteeringdloc').classList.add('hidden')
       }
    ...
    return(
        ...
        <div  className="loc-menu bg-dark w-full md:h-full " style={
            {
            ...
            <div className='loc-menu-content px-4'> 
                <TitleSeparator title='CHOOSE LOCATION FOR VOLUNTEERING' color='text-white' weight='font-semibold'/>
...
export default VolunteeringLoc