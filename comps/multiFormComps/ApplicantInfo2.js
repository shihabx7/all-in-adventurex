...
const ApplicantInfo2=({prevFormErr,appInfo2,setAppInfo2,setFormErrFlag,locationlist})=>{
    ...
    return(
        <div>
            ...
            <div className="form-holedr"> 
                 {/*========================  contact form row desired LOCATION + Position Desired*=======================*/}
                        <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
                                         <div className="form-col w-full md:w-[49%]">
                                            <p className=" mb-1 lg:text-lg evevt-input-label text-[#313030]">Desired Location *</p>
                                            
                                               <select
                                               onChange={(e)=>checkLocation(e)}
                                                 defaultValue={appInfo2.dLocation}
                                                className={"w-full event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent "+ (appInfo2.dLocation.length>0? "focus-green":"")+(appInfo2Err.dLocationErr==true? "focus-red":"")} 
                                               >
                                                <option value=''>Select location</option>
                                                {
                                                ...
                                                
                                                    {
                                                            ...
                                                            <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">Select your desired location</p>
                                                    }
                                                    {
                                                        ((prevFormErr && appInfo2.dLocation=='') && !appInfo2Err.dLocationErr)&&
                                                        <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">Select your desired location</p>
                                                    }
                                            </div>
                                         <div className="form-col w-full md:w-[49%]">
                                             <p className=" mb-1 lg:text-lg evevt-input-label text-[#313030]">Desired Position *</p>
                                            
                                             <select
                                                onChange={(e)=>checkPosition(e)}
                                                 defaultValue={appInfo2.dPosition}
                                                className={"w-full event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent "+ (appInfo2.dPosition>0? "focus-green":"")+(appInfo2Err.dPositionErr==true? "focus-red":"")} 
                                                >
                                                 <option value=''>Select position</option>
                                                <option value="Associate">Associate </option>
                                                <option value="Associate">Team Lead </option>
                                                <option value="Associate">Assistant Manager </option>
                                                <option value="Associate">Store Manager</option>
                                                
                                             </select>
                                                  {
                                                            appInfo2Err.dPositionErr  &&
                                                            <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">Select your desired job position</p>
                                                    }
                                                    {
                                                       
                                                        ((prevFormErr && appInfo2.dPosition=='') && !appInfo2Err.dPositionErr) &&
                                                        <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">Select your desired job position</p>
                                                    }
                                         </div>
                        </div>
                ...
                <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
                                            <div className="form-col w-full md:w-[49%]">
                                                <p className="mb-1 lg:text-lg evevt-input-label text-[#313030]">Desired Pay Range ($) * </p>
                                                <input 
                                                    ...
                                                    className={"w-full event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent "+ (appInfo2.dPay.length>2? "focus-green":"")+(appInfo2Err.dPayErr==true? "focus-red":"")} 
                                                    >

                                                    </input>
                                                    {
                                                            (appInfo2Err.dPayErr && appInfo2.dPay.length>0 ) &&
                                                            <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">Invalid</p>
                                                    }
                                                    {
                                                            (appInfo2Err.dPayErr && appInfo2.dPay.length==0) &&
                                         ...
                                         <div className="form-col w-full md:w-[49%]">
                                                ...
                                                className={"w-full event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent "+ (appInfo2.dSchedule>0? "focus-green":"")+(appInfo2Err.dScheduleErr==true? "focus-red":"")} 
                                                >
                                                ...
                                                <option value="Other">Other</option>
                                             ...
                                             </select>
                                                  {
                                                            ...
                                                            <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">Select your desired schedule</p>
                                                    }
                                                    {
                                                        ((prevFormErr && appInfo2.dSchedule=='') && !appInfo2Err.dScheduleErr) &&
                                                        <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">Select your desired schedule</p>
                                                    }
                                         </div>
                </div>
                ...
                <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-4">
                                            ...
                                            </div>
                                            {
                                                        ...
                                                        <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">Check if you are 18+ or not</p>
                                                    }
                                         </div>
                                         <div className="form-col w-full md:w-[48%]">
                                             <p className="mb-1 lg:text-lg evevt-input-label text-[#313030]">Are you eligible to work in the US? *</p>
                                                ...
                                                </div>
                                                {
                                                        ...
                                                        <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">Check if you are eligible or not</p>
                                                    }
                                         </div>
                </div>
                {/*======================== 18+?    + eligible end=======================*/}
                ...
                <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
                                            <div className="form-col w-full ">
                                                <p className="mb-1 lg:text-lg evevt-input-label text-[#313030]">Have you ever worked for All In Adventures, Escape the Mystery Room, or Mystery Room in the past? </p>
                                                    ...
                                                    className={"w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent "+ (appInfo2.everWorkPast.length>0? "focus-green":"")}
                                                    ...
                                                    </textarea>
                                                    {
                                                        ...
                                                        <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">6-100 character allowed </p>
                                                    }
                                         </div>
                 ...
                 <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
                                      <div className="form-col w-full md:w-[49%]">
                                                ...
                                                <input  type="text"
                                                        ...
                                                        className={"w-full event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent "+ (appInfo2.workUnderOther.length>2? "focus-green":"")}
                                                     ...
                                                     </input>
                                                     {
                                                        ...
                                                        <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">3-100 character allowed </p>
                                                    }
                                         </div>
                                         <div className="form-col w-full md:w-[49%]">
                                                ...
                                                <input  type="text"
                                                        ...
                                                        className={"w-full event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent "+ (appInfo2.learnAboutPos.length>5? "focus-green":"")}
                                            ...
                                            <div className="form-col w-full ">
                                                <p className="mb-1 lg:text-lg evevt-input-label text-[#313030]">What attracted you to the company? </p>
                                                    ...
                                                    defaultValue={appInfo2.whatAttracted}
                                                      className={"w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent "+ (appInfo2.whatAttracted.length>0? "focus-green":"")}
                                                    ...
                                                    </textarea>
                                                    {
                                                        ...
                                                        <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">6-120 character allowed </p>
                                                    }
                                         </div>
