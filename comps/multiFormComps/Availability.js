...
const Availability = ({
  ...
  const checkAvltowork = (e, ckey) => {
    ...
    if (check) {
      ...
      if (checkval == "tg") {
        setAvailability({
          ...availability,
          avlToWork: { ...availability.avlToWork, tg: true },
        });
      }
      if (checkval == "cmp") {
        setAvailability({
          ...availability,
          avlToWork: { ...availability.avlToWork, cmp: true },
        });
      }
      if (checkval == "cmo") {
        setAvailability({
          ...availability,
          avlToWork: { ...availability.avlToWork, cmo: true },
        });
      }
      if (checkval == "none") {
        ...
        setAvailability({
          ...availability,
          avlToWork: { ...availability.avlToWork, none: true },
        });
      ...
      if (checkval == "tg") {
        setAvailability({
          ...availability,
          avlToWork: { ...availability.avlToWork, tg: false },
        });
        if (
          availability.avlToWork.cmp == false &&
          availability.avlToWork.cmo == false &&
          availability.avlToWork.none == false
        ) {
          setFormErrFlag(true);
      ...
      if (checkval == "cmp") {
        setAvailability({
          ...availability,
          avlToWork: { ...availability.avlToWork, cmp: false },
        });
        if (
          availability.avlToWork.tg == false &&
          availability.avlToWork.cmo == false &&
          availability.avlToWork.none == false
        ) {
          setFormErrFlag(true);
      ...
      if (checkval == "cmo") {
        setAvailability({
          ...availability,
          avlToWork: { ...availability.avlToWork, cmo: false },
        });
        if (
          availability.avlToWork.tg == false &&
          availability.avlToWork.cmp == false &&
      ...
      if (checkval == "none") {
        setAvailability({
          ...availability,
          avlToWork: { ...availability.avlToWork, none: false },
        });
        if (
          availability.avlToWork.tg == false &&
          availability.avlToWork.cmp == false &&
  ...
  const checkCloseTime = (e, day) => {
    ...
    if (checkcTime != "") {
      ...
      setAvailability({
        ...availability,
        [checkcDay]: { ...availability[checkcDay], close: checkcTime },
      });
      e.target.classList.remove("focus-red");
      e.target.classList.add("focus-green");
    } else {
      ...
      <div className="form-holedr mt-4">
        ...
        <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-2 md:my-4">
          <div className="form-col w-full ">
            <p className="mb-1 lg:text-lg evevt-input-label text-[#313030]">
              What is your immediate career objective? *
            </p>
            ...
            <textarea
              ...
              className={
                ...
                (availability.careerObjective.length > 9 ? "focus-green" : "")
              }
              placeholder="Your career objective"
            ></textarea>
            {avlErr.careerObjectiveErr &&
              availability.careerObjective.length > 0 && (
                <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                  Min 10 and Max 180 character allowed{" "}
                </p>
              )}
            {avlErr.careerObjectiveErr &&
              availability.careerObjective.length == 0 && (
        ...
        <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
          <div className="form-col w-full md:w-[42%]">
            ...
            <input
              ...
              className={
                "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent " +
                (availability.avlStartDate.length > 0 ? "focus-green" : "")
              }
            />
            {avlErr.avlStartDateErr && availability.avlStartDate.length > 0 && (
              <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                Invalid date. Select date at least one day after current date
              </p>
            )}
            {avlErr.avlStartDateErr &&
              availability.avlStartDate.length == 0 && (
                <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                  Select availability start date.
                </p>
              )}
            {prevFormErr &&
              availability.avlStartDate == "" &&
              !avlErr.avlStartDateErr && (
                <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                  Select availability start date.
                </p>
          ...
          <div className="form-col w-full md:w-[54%] mt-2 md:mt-0">
            <p className=" mb-2 md:mb-1 lg:text-lg evevt-input-label text-[#111111]  ">
              Check those you will be available to work: *
            </p>
            <div className="form-check flex flex-col md:flex-row md:items-center space-x-0 space-y-2 md:space-y-0 w-full justify-start flex-wrap">
              <div className="flex items-center  space-x-2 md:w-[48%] ">
                <input
                  ...
                  id="tq"
                />
                <label htmlFor="tq" className="text-[#464646]">
              ...
              <div className="flex items-center space-x-2 md:w-[48%] ">
                <input
                  ...
                  id="cwp"
                />
                <label htmlFor="cwp" className="text-[#464646]">
                  Christmas (week prior)
                </label>
              </div>
              ...
              <div className="flex items-center space-x-2 md:w-[48%] md:pt-1 ">
                <input
                  ...
                  id="cwo"
                />
                <label htmlFor="cwo" className="text-[#464646]">
                  Christmas (week of)
                </label>
              </div>
              ...
              <div className="flex items-center space-x-2 md:w-[48%] md:pt-1 ">
                <input
                  ...
                  id="none"
                />
                <label htmlFor="none" className="text-[#464646]">
                  None
                </label>
              </div>
            </div>
            ...
            {prevFormErr &&
              !availability.avlToWork.tg &&
              !availability.avlToWork.cmp &&
              !availability.avlToWork.cmo &&
              !availability.avlToWork.none && (
                <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                  Check at least one option{" "}
                </p>
              )}
        ...
        <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
          <div className="form-col w-full bg-[#FFF9EC] p-4 md:py-8 md:px-6 my-2 md:my-4">
            <p className="mb-1 lg:text-lg evevt-input-label text-[#313030]">
              Please indicate hours you're available to work during both day and
              evening *
            </p>
            <p className="mb-1 lg:text-lg evevt-input-label text-[#565656]">
              (i.e. Start - Close; 9 am-12 pm; or Any)
            </p>
            {/*======================== sunday=======================*/}
            <div className="avl-work-week sunday">
              <div className="avl-row flex  justify-between  space-x-2 md:space-x-6 md:max-w-[800px] mt-4 ">
                <div className="avl-day text-sm md:text-xl mt-[6px] md:mt-[6px]">
                  <p>Sunday :</p>
                </div>
                <div className="flex justify-between w-[68%] xs:w-[66%] sm:w-[78%] md:w-[80%] space-x-2 md:space-x-6 ">
                  <div className="avl-start w-[48%]">
                    <select
                      ...
                      className={
                        "text-xs md:text-base w-full event-input text-gray-800  border-0 md:py-2 px-2 md:px-4 bg-[#F4E6C3] focus:ring-transparent " +
                        (availability.sunday.start != "" ? "focus-green" : "") +
                        (prevFormErr == true && availability.sunday.start == ""
                          ? "focus-red"
                          : "") +
                  ...
                  <div className="avl-end w-[48%]">
                    <select
                      ...
                      className={
                        "text-xs md:text-base w-full event-input text-gray-800  border-0 md:py-2 px-2 md:px-4 bg-[#F4E6C3] focus:ring-transparent " +
                        (availability.sunday.close != "" ? "focus-green" : "") +
                        (prevFormErr == true && availability.sunday.close == ""
                          ? "focus-red"
                          : "") +
                ...
                <div className="flex justify-between w-[68%] xs:w-[66%] sm:w-[78%] md:w-[80%] space-x-2 md:space-x-6 ">
                  <div className="avl-start w-[48%]">
                    <select
                      ...
                      className={
                        "text-xs md:text-base w-full event-input text-gray-800  border-0 md:py-2 px-2 md:px-4 bg-[#F4E6C3] focus:ring-transparent " +
                        (availability.monday.start != "" ? "focus-green" : "") +
                        (prevFormErr == true && availability.monday.start == ""
                          ? "focus-red"
                          : "") +
                  ...
                  <div className="avl-end w-[48%]">
                    <select
                      ...
                      className={
                        "text-xs md:text-base w-full event-input text-gray-800  border-0 md:py-2 px-2 md:px-4 bg-[#F4E6C3] focus:ring-transparent " +
                        (availability.monday.close != "" ? "focus-green" : "") +
                        (prevFormErr == true && availability.monday.close == ""
                          ? "focus-red"
                          : "") +
                ...
                <div className="flex justify-between w-[68%] xs:w-[66%] sm:w-[78%] md:w-[80%] space-x-2 md:space-x-6 ">
                  <div className="avl-start w-[48%]">
                    <select
                      ...
                      className={
                        "text-xs md:text-base w-full event-input text-gray-800  border-0 md:py-2 px-2 md:px-4 bg-[#F4E6C3] focus:ring-transparent " +
                        (availability.tuesday.start != ""
                          ? "focus-green"
                          : "") +
                        (prevFormErr == true && availability.tuesday.start == ""
                          ? "focus-red"
                          : "") +
                  ...
                  <div className="avl-end w-[48%]">
                    <select
                      ...
                      className={
                        "text-xs md:text-base w-full event-input text-gray-800  border-0 md:py-2 px-2 md:px-4 bg-[#F4E6C3] focus:ring-transparent " +
                        (availability.tuesday.close != ""
                          ? "focus-green"
                          : "") +
                        (prevFormErr == true && availability.tuesday.close == ""
                          ? "focus-red"
                          : "") +
                ...
                <div className="flex justify-between w-[68%] xs:w-[66%] sm:w-[78%] md:w-[80%] space-x-2 md:space-x-6 ">
                  <div className="avl-start w-[48%]">
                    <select
                      ...
                      className={
                        "text-xs md:text-base w-full event-input text-gray-800  border-0 md:py-2 px-2 md:px-4 bg-[#F4E6C3] focus:ring-transparent " +
                        (availability.friday.start != "" ? "focus-green" : "") +
                        (prevFormErr == true && availability.friday.start == ""
                          ? "focus-red"
                          : "") +
                  ...
                  <div className="avl-end w-[48%]">
                    <select
                      ...
                      className={
                        "text-xs md:text-base w-full event-input text-gray-800  border-0 md:py-2 px-2 md:px-4 bg-[#F4E6C3] focus:ring-transparent " +
                        (availability.friday.close != "" ? "focus-green" : "") +
                        (prevFormErr == true && availability.friday.close == ""
                          ? "focus-red"
                          : "") +
            ...
            <p className="mt-1 text-sm md:text-base evevt-input-label text-red-700 fErr hidden">
              email *
            </p>
          </div>
        </div>
        ...
        <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
          <div className="form-col w-full ">
            <p className="mb-1 lg:text-lg evevt-input-label text-[#313030]">
              If offered a job, how long do you plan to stay? *
            </p>
            ...
            <textarea
              ...
              className={
                "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent " +
                (availability.howLongStay.length > 9 ? "focus-green" : "")
              }
            ></textarea>
            {avlErr.howLongStayErr && availability.howLongStay.length > 0 && (
              <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                Min 10 and Max 120 character allowed{" "}
              </p>
            )}
            {avlErr.howLongStayErr && availability.howLongStay.length == 0 && (
              <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
            ...
            {prevFormErr &&
              availability.howLongStay == "" &&
              !avlErr.howLongStayErr && (
                <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                  This field must not be empty.
                </p>
              )}
