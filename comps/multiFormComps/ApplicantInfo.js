        ...
        <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
          <div className="form-col w-full md:w-[49%]">
            ...
            <input
              ...
              className={
                ...
                (appInfo1.fName.length > 2 ? "focus-green" : "")
              }
            ...
            {appInfoErr.fnameErr && appInfo1.fName.length > 0 && (
              <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                Only letter and space allowed (between 3-20 character)
              </p>
            )}
            {appInfoErr.fnameErr && appInfo1.fName.length == 0 && (
              <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
          ...
          <div className="form-col w-full md:w-[49%]">
            ...
            <input
              ...
              className={
                "w-full event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent " +
                (appInfo1.lName.length > 2 ? "focus-green" : "")
              }
        ...
        <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
          <div className="form-col w-full md:w-[49%]">
            ...
            <input
              ...
              className={
                "w-full event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent " +
                (appInfo1.email.length > 6 ? "focus-green" : "")
              }
          ...
          <div className="form-col w-full md:w-[49%]">
            ...
            <input
              ...
              className={
                "w-full event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent " +
                (appInfo1.phone.length > 7 ? "focus-green" : "")
              }
              placeholder="Your phone number"
              defaultValue={appInfo1.phone}
              title="Only number -,(,) and + are allowed"
              required
            ></input>
        ...
        <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
          <div className="form-col w-full md:w-[49%]">
            ...
            <input
              ...
              className={
                "w-full event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent " +
                (appInfo1.stAdd1.length > 2 ? "focus-green" : "")
              }
              placeholder="Address"
          ...
          <div className="form-col w-full md:w-[49%]">
            ...
            <input
              ...
              className={
                "w-full event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent " +
                (appInfo1.stAdd2.length > 3 ? "focus-green" : "")
              }
        ...
        <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
          <div className="form-col w-full md:w-[49%]">
            ...
            <input
              ...
              className={
                "w-full event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent " +
                (appInfo1.city.length > 3 ? "focus-green" : "")
              }
          ...
          <div className="form-col w-full md:w-[49%]">
            ...
            <input
              ...
              className={
                "w-full event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent " +
                (appInfo1.state.length > 2 ? "focus-green" : "")
              }
        ...
        <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
          <div className="form-col w-full md:w-[49%]">
            ...
            <input
              ...
              className={
                "w-full event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent " +
                (appInfo1.zip.length > 0 ? "focus-green" : "")
              }
          ...
          <div className="form-col w-full md:w-[49%]">
            ...
            <select
              ...
              className={
                "w-full event-input border-0 md:py-3 px-4 bg-white focus:ring-transparent " +
                (appInfo1.country.length > 0 ? "focus-green" : "")
              }
