...
const Experience = ({ jobExp, setJobExp, setFormErrFlag, jobPrevErr }) => {
  ...
  const checkCompanyName = (e, job) => {
    ...
    if (cname.length > 2 && cname.length < 41) {
      if (!namePatt.test(cname)) {
        ...
        setExpErr({
          ...expErr,
          [errname]: { ...expErr[errname], companyName: true },
        });
        ...
        setExpErr({
          ...expErr,
          [errname]: { ...expErr[errname], companyName: false },
        });
        setJobExp({
          ...jobExp,
          [jobname]: { ...jobExp[jobname], companyName: cname },
        });
  ...
  const checkTitleName = (e, job) => {
    ...
    if (cname.length > 2 && cname.length < 41) {
      if (!namePatt.test(cname)) {
        ...
        setExpErr({
          ...expErr,
          [errname]: { ...expErr[errname], title: true },
        });
        e.target.classList.remove("focus-green");
        e.target.classList.add("focus-red");
      } else {
        ...
        setExpErr({
          ...expErr,
          [errname]: { ...expErr[errname], title: false },
        });
        setJobExp({
          ...jobExp,
          [jobname]: { ...jobExp[jobname], title: cname },
        });
        e.target.classList.remove("focus-red");
        e.target.classList.add("focus-green");
      }
  ...
  const checkSpName = (e, job) => {
    ...
    if (cname.length > 2 && cname.length < 41) {
      if (!namePatt.test(cname)) {
        ...
        setExpErr({
          ...expErr,
          [errname]: { ...expErr[errname], spName: true },
        });
        e.target.classList.remove("focus-green");
        e.target.classList.add("focus-red");
      } else {
        ...
        setExpErr({
          ...expErr,
          [errname]: { ...expErr[errname], spName: false },
        });
        setJobExp({
          ...jobExp,
          [jobname]: { ...jobExp[jobname], spName: cname },
        });
        e.target.classList.remove("focus-red");
        e.target.classList.add("focus-green");
      }
  ...
  const checkSpPhone = (e, job) => {
    ...
    if (cname.length > 6 && cname.length < 19) {
      if (!namePatt.test(cname)) {
        ...
        setExpErr({
          ...expErr,
          [errname]: { ...expErr[errname], spPhone: true },
        });
        e.target.classList.remove("focus-green");
        e.target.classList.add("focus-red");
      } else {
        ...
        setExpErr({
          ...expErr,
          [errname]: { ...expErr[errname], spPhone: false },
        });
        setJobExp({
          ...jobExp,
          [jobname]: { ...jobExp[jobname], spPhone: cname },
        });
        e.target.classList.remove("focus-red");
        e.target.classList.add("focus-green");
      }
  ...
  const checkDateOfEmployment = (e, job) => {
    ...
    if (cname.length > 2 && cname.length < 21) {
      ...
      setExpErr({
        ...expErr,
        [errname]: { ...expErr[errname], dateOfEmployment: false },
      });
      setJobExp({
        ...jobExp,
        [jobname]: { ...jobExp[jobname], dateOfEmployment: cname },
      });
      e.target.classList.remove("focus-red");
      e.target.classList.add("focus-green");
    } else {
      ...
      setExpErr({
        ...expErr,
        [errname]: { ...expErr[errname], dateOfEmployment: true },
      });
      setJobExp({
        ...jobExp,
        [jobname]: { ...jobExp[jobname], dateOfEmployment: cname },
  ...
  const checkIsContact = (e, job) => {
    ...
    if (cname.length > 0) {
      ...
      setExpErr({
        ...expErr,
        [errname]: { ...expErr[errname], isContact: false },
      });
      setJobExp({
        ...jobExp,
        [jobname]: { ...jobExp[jobname], isContact: cname },
      });
      e.target.classList.remove("focus-red");
      e.target.classList.add("focus-green");
    } else {
      ...
      setExpErr({
        ...expErr,
        [errname]: { ...expErr[errname], isContact: true },
      });
      setJobExp({
        ...jobExp,
        [jobname]: { ...jobExp[jobname], isContact: cname },
  ...
  const checkMajorResponsibility = (e, job) => {
    ...
    if (cname.length > 2 && cname.length < 141) {
      ...
      setExpErr({
        ...expErr,
        [errname]: { ...expErr[errname], majorResponsibility: false },
      });
      setJobExp({
        ...jobExp,
        [jobname]: { ...jobExp[jobname], majorResponsibility: cname },
      });
      e.target.classList.remove("focus-red");
      e.target.classList.add("focus-green");
    } else {
      ...
      setExpErr({
        ...expErr,
        [errname]: { ...expErr[errname], majorResponsibility: true },
      });
      setJobExp({
        ...jobExp,
        [jobname]: { ...jobExp[jobname], majorResponsibility: cname },
  ...
  const checkReasonForLeaving = (e, job) => {
    ...
    if (cname.length > 2 && cname.length < 141) {
      ...
      setExpErr({
        ...expErr,
        [errname]: { ...expErr[errname], reasonForLeaving: false },
      });
      setJobExp({
        ...jobExp,
        [jobname]: { ...jobExp[jobname], reasonForLeaving: cname },
      });
      e.target.classList.remove("focus-red");
      e.target.classList.add("focus-green");
    } else {
      ...
      setExpErr({
        ...expErr,
        [errname]: { ...expErr[errname], reasonForLeaving: true },
      });
      setJobExp({
        ...jobExp,
        [jobname]: { ...jobExp[jobname], reasonForLeaving: cname },
  ...
  return (
    <div>
      <div className="form-holedr">
        ...
        <p className="md:text-lg mt-4 pb-2">
          List your last three (3) jobs, beginning with your current or most
          recent position. Include all seasonal, part-time, summer,
          self-employment, etc. Please ensure all dates/job files in this
        ...
        <div className="form-exp-box bg-[#FFF7EA] p-4 md:p-6 mt-4 shadow-md">
          ...
          >
            <h3 className="md:text-xl">Job 1</h3>{" "}
              ...
              <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      ...
                      (jobExp.job1.companyName > 5 ? "focus-green " : "") +
                      (jobPrevErr.jobErr1 && jobExp.job1.companyName == ""
                        ? "focus-red"
                        : "")
                    }
                    placeholder="Your company name"
                  ></input>
                  {expErr.jobErr1.companyName &&
                    jobExp.job1.companyName.length > 0 && (
                      <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                        Only letter, number and space allowed (between 6-40
                        character)
                      </p>
                    )}

                  {jobPrevErr.jobErr1 &&
                    jobExp.job1.companyName == "" &&
                    !expErr.jobErr1.companyName && (
                      <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                ...
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job1.title > 5 ? "focus-green " : "") +
                      (jobPrevErr.jobErr1 && jobExp.job1.title == ""
                        ? "focus-red"
                        : "")
                    }
              ...
              <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job1.spName > 5 ? "focus-green " : "") +
                      (jobPrevErr.jobErr1 && jobExp.job1.spName == ""
                        ? "focus-red"
                        : "")
                    }
                ...
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job1.spPhone > 5 ? "focus-green " : "") +
                      (jobPrevErr.jobErr1 && jobExp.job1.spName == ""
                        ? "focus-red"
                        : "")
                    }
              ...
              <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job1.dateOfEmployment > 0 ? "focus-green " : "") +
                      (jobPrevErr.jobErr1 && jobExp.job1.dateOfEmployment == ""
                        ? "focus-red"
                        : "")
                    }
                    placeholder="02/2000"
                  ...
                  {expErr.jobErr1.dateOfEmployment &&
                    jobExp.job1.dateOfEmployment.length > 0 && (
                      <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                ...
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <select
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job1.isContact > 0 ? "focus-green " : "") +
                      (jobPrevErr.jobErr1 && jobExp.job1.isContact == ""
                        ? "focus-red"
                        : "")
                    }
                  ...
                  {jobPrevErr.jobErr1 &&
                    jobExp.job1.isContact == "" &&
                    !expErr.jobErr1.isContact && (
                      <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                        This field must not be empty
                      </p>
                    )}
              ...
              <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job1.majorResponsibility > 5
                        ? "focus-green "
                        : "") +
                      (jobPrevErr.jobErr1 &&
                      jobExp.job1.majorResponsibility.length < 5
                        ? "focus-red"
                        : "")
                    }
                  />

                  {expErr.jobErr1.majorResponsibility &&
                    jobExp.job1.majorResponsibility != "" && (
                      <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                        Only letter, number and space allowed (between 6-40
                        character)
                      </p>
                ...
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job1.majorResponsibility > 2
                        ? "focus-green "
                        : "") +
                      (jobPrevErr.jobErr1 &&
                      jobExp.job1.majorResponsibility.length < 2
                        ? "focus-red"
                        : "")
                    }
                  />
                  {expErr.jobErr1.reasonForLeaving &&
                    jobExp.job1.reasonForLeaving != "" && (
                      <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                        Only letter, number and space allowed (between 6-40
                        character)
                      </p>
        ...
        <div className="form-exp-box bg-[#FFF7EA] p-4 md:p-6 mt-4 shadow-md">
          ...
          >
            <h3 className="md:text-xl">Job 2</h3>{" "}
            <span className="md:text-xl text-[#333105]">
          ...
          {exp == 2 && (
            <div
              className={
                "f-job-bottom mt-2 border-t border-gray-300 " +
                (jobPrevErr.jobErr2 == true ? "focus-red" : "")
              }
            >
              <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job2.companyName > 5 ? "focus-green " : "") +
                      (jobPrevErr.jobErr2 && jobExp.job2.companyName == ""
                        ? "focus-red"
                        : "")
                    }
                    placeholder="Your company name"
                  ></input>
                  {expErr.jobErr2.companyName &&
                    jobExp.job2.companyName.length > 0 && (
                      <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                        Only letter, number and space allowed (between 6-40
                        character)
                      </p>
                ...
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job2.title > 5 ? "focus-green " : "") +
                      (jobPrevErr.jobErr2 && jobExp.job2.title == ""
                        ? "focus-red"
                        : "")
                    }
                    placeholder="Your job title"
              ...
              <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job2.spName > 5 ? "focus-green " : "") +
                      (jobPrevErr.jobErr2 && jobExp.job2.spName == ""
                        ? "focus-red"
                        : "")
                    }
                    placeholder="Your supervisor's name"
                ...
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job2.spPhone > 5 ? "focus-green " : "") +
                      (jobPrevErr.jobErr2 && jobExp.job2.spName == ""
                        ? "focus-red"
                        : "")
                    }
              ...
              <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job2.dateOfEmployment > 0 ? "focus-green " : "") +
                      (jobPrevErr.jobErr2 && jobExp.job2.dateOfEmployment == ""
                        ? "focus-red"
                        : "")
                    }
                    placeholder="02/2000"
                  ...
                  {expErr.jobErr2.dateOfEmployment &&
                    jobExp.job2.dateOfEmployment.length > 0 && (
                      <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                        Invalid date formate
                      </p>
                    )}
                ...
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <select
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job2.isContact > 0 ? "focus-green " : "") +
                      (jobPrevErr.jobErr2 && jobExp.job2.isContact == ""
                        ? "focus-red"
                        : "")
                    }
                  >
                  ...
                  {jobPrevErr.jobErr2 &&
                    jobExp.job2.isContact == "" &&
                    !expErr.jobErr2.isContact && (
                      <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                        This field must not be empty
                      </p>
                    )}
              ...
              <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job2.majorResponsibility > 5
                        ? "focus-green "
                        : "") +
                      (jobPrevErr.jobErr2 &&
                      jobExp.job2.majorResponsibility.length < 5
                        ? "focus-red"
                        : "")
                    }
                  />

                  {expErr.jobErr2.majorResponsibility &&
                    jobExp.job2.majorResponsibility != "" && (
                      <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                        Only letter, number and space allowed (between 6-40
                        character)
                      </p>
                ...
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job2.majorResponsibility > 2
                        ? "focus-green "
                        : "") +
                      (jobPrevErr.jobErr2 &&
                      jobExp.job2.majorResponsibility.length < 2
                        ? "focus-red"
                        : "")
                    }
                  />
                  {expErr.jobErr2.reasonForLeaving &&
                    jobExp.job2.reasonForLeaving != "" && (
                      <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                        Only letter, number and space allowed (between 6-40
                        character)
                      </p>
        ...
        <div className="form-exp-box bg-[#FFF7EA] p-4 md:p-6 mt-4 shadow-md">
          ...
          >
            <h3 className="md:text-xl">Job 3</h3>{" "}
            <span className="md:text-xl text-[#333105]">
          ...
          {exp == 3 && (
            <div
              className={
                "f-job-bottom mt-2 border-t border-gray-300 " +
                (jobPrevErr.jobErr3 == true ? "focus-red" : "")
              }
            >
              <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job3.companyName > 5 ? "focus-green " : "") +
                      (jobPrevErr.jobErr3 && jobExp.job3.companyName == ""
                        ? "focus-red"
                        : "")
                    }
                    placeholder="Your company name"
                  ></input>
                  {expErr.jobErr3.companyName &&
                    jobExp.job3.companyName.length > 0 && (
                      <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                        Only letter, number and space allowed (between 6-40
                        character)
                      </p>
                ...
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job3.title > 5 ? "focus-green " : "") +
                      (jobPrevErr.jobErr3 && jobExp.job3.title == ""
                        ? "focus-red"
                        : "")
                    }
                    placeholder="Your job title"
              ...
              <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job3.spName > 5 ? "focus-green " : "") +
                      (jobPrevErr.jobErr3 && jobExp.job3.spName == ""
                        ? "focus-red"
                        : "")
                    }
                    placeholder="Your supervisor's name"
                ...
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job3.spPhone > 5 ? "focus-green " : "") +
                      (jobPrevErr.jobErr3 && jobExp.job3.spName == ""
                        ? "focus-red"
                        : "")
                    }
              ...
              <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job3.dateOfEmployment > 0 ? "focus-green " : "") +
                      (jobPrevErr.jobErr3 && jobExp.job3.dateOfEmployment == ""
                        ? "focus-red"
                        : "")
                    }
                    placeholder="02/1999"
                  ...
                  {expErr.jobErr3.dateOfEmployment &&
                    jobExp.job3.dateOfEmployment.length > 0 && (
                      <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                        Invalid date formate
                      </p>
                    )}
                ...
                <div className="form-col w-full md:w-[49%]">
                  ...
                  {jobPrevErr.jobErr3 &&
                    jobExp.job3.isContact == "" &&
                    !expErr.jobErr3.isContact && (
                      <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                        This field must not be empty
                      </p>
                    )}
              ...
              <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between my-3">
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    onChange={(e) => checkMajorResponsibility(e, 3)}
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job3.majorResponsibility > 5
                        ? "focus-green "
                        : "") +
                      (jobPrevErr.jobErr2 &&
                      jobExp.job3.majorResponsibility.length < 5
                        ? "focus-red"
                        : "")
                    }
                  />

                  {expErr.jobErr3.majorResponsibility &&
                    jobExp.job3.majorResponsibility != "" && (
                      <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                        Only letter, number and space allowed (between 6-40
                        character)
                      </p>
                ...
                <div className="form-col w-full md:w-[49%]">
                  ...
                  <input
                    ...
                    className={
                      "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#F4E6C3] focus:ring-transparent " +
                      (jobExp.job3.majorResponsibility > 2
                        ? "focus-green "
                        : "") +
                      (jobPrevErr.jobErr3 &&
                      jobExp.job3.majorResponsibility.length < 2
                        ? "focus-red"
                        : "")
                    }
                  />
                  {expErr.jobErr3.reasonForLeaving &&
                    jobExp.job3.reasonForLeaving != "" && (
                      <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                        Only letter, number and space allowed (between 6-40
                        character)
                      </p>
        ...
        <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between mt-6">
          <div className="form-col w-full md:w-[36%]">
            ...
            <select
              ...
              className={
                "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#FFF7EA] focus:ring-transparent " +
                (jobExp.isEmployed != "" ? "focus-green " : "") +
            ...
            {expErr.isEmployedErr && (
              <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                Select if you are employed or not
              </p>
            )}
          ...
          <div className="form-col w-full md:w-[62%]">
            <p className=" mb-1 lg:text-lg evevt-input-label text-gray-800">
              List 3 skills from your work experiences
            ...
            <input
              ...
              className={
                "w-full max-h-[68px] event-input border-0 md:py-3 px-4 bg-[#FFF7EA] focus:ring-transparent " +
                (jobExp.skillList != "" ? "focus-green " : "") +
                (jobPrevErr.skillListErr ? "focus-red" : "")
              }
            ></input>
            {expErr.skillListErr && jobExp.skillList.length != "" && (
              <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr text-xs md:text-sm">
                Only letter, number and space allowed (between 3-40 character)
              </p>
            )}
