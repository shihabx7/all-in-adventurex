 ...
 // Applicant info 2 data end
    ...
    const checkAppInfo2=()=>{
       ...
       for (const key in appInfo2) { 
           ...
           if(key!='everWorkPast' && key!='workUnderOther' && key!='learnAboutPos' && key!='whatAttracted'){
               if(appInfo2[key]==''){
                   emptycount=emptycount+1
               } 
...
const [prevEduErr,setPrevEduErr]=useState({
   ...
   const [education,setEducation]=useState({
    ...
    const checkEducation=()=>{
        ...
        if(ederr.hschoolempty==4 && ederr.collegeempty==4 && ederr.otherempty==4){
            ederr.alleempty= 1
            ederr.earr=true
        }
    ...
    const nextStep=()=>{
        if(formErrFlag==false){
            ...
            if(formStep==3){
                ...
                if(chEdu.hschoolempty==4 && chEdu.collegeempty==4 && chEdu.otherempty==4){
            ...
            if(formStep==4){
                ...
                if(!chExp.jobAllErr && !chExp.skillListErr && !chExp.jobErr1 && !chExp.jobErr2 && !chExp.jobErr3){
                    setPrevFormErr(false)
                    setFormStep(formStep+1)
                }
    ...
    return (
        <div className="job-form">
            ...
            <div className="job-form-body">
                {
                    formStep==0 && 
                    <ApplicantInfo prevFormErr={prevFormErr} appInfo1={appInfo1} setAppInfo1={setAppInfo1} setFormErrFlag={setFormErrFlag}/>
                }
                {
                    formStep==1 && 
                    <ApplicantInfo2 prevFormErr={prevFormErr} locationlist={props.locationlist} appInfo2={appInfo2} setAppInfo2={setAppInfo2} setFormErrFlag={setFormErrFlag}/>
                }
                {
                    formStep==2 && 
                    <Availability prevFormErr={prevFormErr} availability={availability} setAvailability={setAvailability} setFormErrFlag={setFormErrFlag}/>
                }
                 {
                    formStep==3 && 
                    <Education prevEduErr={prevEduErr} education={education} setEducation={setEducation} setFormErrFlag={setFormErrFlag}/>
                }
                 {
                    formStep==4 && 
                    <Experience jobExp={jobExp} setJobExp={setJobExp} setFormErrFlag={setFormErrFlag} jobPrevErr={jobPrevErr}/>
                }
                {
                    formStep==5 && 
                    <References  references={references} setReferences={setReferences} setFormErrFlag={setFormErrFlag} refPrevErr={refPrevErr}/>
                }
