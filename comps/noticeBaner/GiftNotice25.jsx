...
export default function GiftNotice25({ locationSlug, giftBooking }) {
        ...
        <div className="notice-content relative z-20">
          <div className="crm-notice-box flex flex-nowrap justify-between items-center sm:space-x-1">
            ...
            <div className="max-w-[94%] rm:max-w-[87%] flex-grow md:max-w-[764px] lg:max-w-[1000px] xl:max-w-[1080px] 2xl:max-w-[1170px] ">
              <div className="bfdy-notice-container  flex flex-wrap md:flex-nowrap   justify-center items-center space-x-1.5 rm:space-x-2 lg:space-x-2 2xl:space-x-4 px-0 sm:px-2 py-1 ">
                {/*=========================================gift cart poster */}
                ...
                <div className="notice-btnt-text w-auto flex justify-center items-center space-x-1.5 rm:space-x-2 md:space-x-1 lg:space-x-2 2xl:space-x-3 ">
                  ...
                  {/*==============================================================crm learn more btn*/}
                  <div className="bfdy-n-item-5  text-[.76rem] rm:text-[.84rem] sm:text-[.88rem] md:text-[.9rem] xl:text-[1.06rem] 2xl:text-[1.1rem] font-medium">
                    <a
