          ...
          <div className="abt-row flex flex-col md:flex-row justify-between items-center">
                    <div className="abt-col md:w-[58%] lg:w-[48%] order-2 md:order-1">
                      <div className="section-title-sep mt-4 md:mt-0">
                        ...
                        <p className="text-gray-700 lg:text-lg mt-4  lg:mt-8">Welcome to our ALL-NEW digital Rewards Program that will provide you with more value on every visit. This program will apply to all experiences All In Adventures has to offer including Escape Rooms, Game Show Room, Axe Throwing and more that will be coming soon! We have partnered with an industry leading rewards program company named Fivestars. Download their free app on your phone so you can track and manage all your rewards in one convenient place.</p>
                        <div className="abt-notice-list mt-4 md:mt-6 lg:mt-8">
                            ...
                            <ul className="star-list pl-4 text-[#464646] mt-4">
                                    <li className="lg:text-lg my-2 md:my-3 ">Strong Brand Reputation &amp; Marketing Guidance</li>
                                    <li className="lg:text-lg my-2 md:my-3 ">Ongoing Operational Support</li>
                                    <li className="lg:text-lg my-2 md:my-3 ">Dual-Phase Training Program + Refresher Training</li>
                                    <li className="lg:text-lg my-2 md:my-3 ">Exclusive Territory</li>
                                    <li className="lg:text-lg my-2 md:my-3 ">Field Support</li>
                            </ul>
