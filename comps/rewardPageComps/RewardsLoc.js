...
const RewardsLoc=(props)=>{
   
       const closelocmenu=()=>{
     
        document.getElementById('rewardloc').classList.add('hidden')
       }
    ...
    return(
        ...
        <div  className="loc-menu bg-dark w-full md:h-full " style={
            ...
            <div className='loc-menu-content px-4'> 
                <TitleSeparator title='CHOOSE LOCATION TO GET REWARDS' color='text-white' weight='font-semibold'/>
