        ...
        <div className="fran-tes bg-cover" id="ready-to-signup" style={{backgroundImage:"url('/assets/franchise-slider-bg.jpg')"}}>
            <div className="section-container max-w-7xl mx-auto px-4 py-16 md:py-20 lg:py-28">
                <div className="max-w-[800px] mx-auto text-center">
                    ...
                    <p className="max-w-2xl md:text-lg mx-auto text-center mt-4 md:mt-8  text-gray-700">Start by selecting your location above. You'll be redirected to the fivestars.com site to complete the quick/easy process.</p>
