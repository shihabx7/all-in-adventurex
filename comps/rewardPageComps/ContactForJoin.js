        ...
        <div className="fran-tes bg-cover" style={{backgroundImage:"url('/assets/franchise-slider-bg.jpg')"}}>
            <div className="section-container max-w-7xl mx-auto px-4 py-16 md:py-20 lg:py-28">
                <div className="max-w-[640px] mx-auto text-center">
                    <h2 className="mb-8 md:mb-12 golden-text text-3xl md:text-4xl font-os font-bold">CHOOSE YOUR LOCATION TO JOIN</h2>
                    ...
                    <p className="max-w-2xl md:text-lg mx-auto text-center mt-4 md:mt-8  text-gray-700">Step inside your exclusive 60 minute private step adventure. Step inside your exclusive 60 minute private step adventure </p>
