      ...
      <div className="section-container max-w-7xl mx-auto px-4 pb-16 md:pb-20 lg:pb-28 relative z-30">
        <div className="abt-row flex flex-col md:flex-row justify-between ">
          <div className="abt-col md:w-[48%] lg:w-[48%] ">
            <div className="abt-notice-list">
              <h2 className="dark-gold text-3xl lg:text-4xl font-os font-bold ">
                EARNING POINTS
              </h2>
              <div className="earning-pts-box mt-4 lg:mt-8">
                <h3 className="font-medium text-[#464646] text-lg lg:text-xl">
              ...
              <div className="earning-pts-box mt-4 lg:mt-6">
                <p className="lg:text-lg text-[#464646]">
                  Plus, take advantage of our surprise offers to earn additional
                  points or redeem additional discounts!
                </p>
              </div>
            </div>
          </div>
          <div
            className="abt-col md:w-[48%] lg:w-[48%] order-1 md:order-2 mt-8 md:mt-0"
            id="redeeming"
          >
            <h2 className="dark-gold text-3xl lg:text-4xl font-os font-bold ">
              REDEEMING POINTS
            ...
            <div className="earning-pts-box mt-4 lg:mt-8">
              <h3 className="font-medium text-[#464646] text-lg lg:text-xl">
                Once you have accumulated your points, you may redeem them for
                the following rewards:
              </h3>
              <ul className="star-list pl-4 text-[#464646] mt-4">
                <li className="lg:text-lg my-2 md:my-3 ">
                  50 points - $5 off one (1) admission (choose any game
                  experience).
                </li>
                <li className="lg:text-lg my-2 md:my-3 ">
                  100 points - 50% off one (1) admission (choose any game
                  experience).
                </li>
                <li className="lg:text-lg my-2 md:my-3 ">
                  150 points - One (1) free admission (choose any game
                  experience).
                </li>
                <li className="lg:text-lg my-2 md:my-3 ">
        ...
        <div className="reedim-note text-[#464646] mt-4 md:mt-8">
          <p className="lg:text-lg italic">
            The Rewards Program remains the property of All In Adventures. All
            In Adventures reserves the right at all times and in its absolute
            discretion and without notice to either amend these terms or with
            reasonable notice to terminate, withdraw or cancel the program.
          </p>
          <ul className="star-list pl-4 text-[#464646] mt-4">
            <li className="lg:text-lg my-2 md:my-3 font-medium">
