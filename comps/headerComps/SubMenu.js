...
const SubMenu=(props)=>{
    ...
    return(
        ...
        <div className="flex flex-col md:flex-row submenu-box md:justify-between pb-[120px] pt-4 md:pb-12 md:pt-10 overflow-scroll md:overflow-hidden h-screen md:h-auto " style={
            {
