...
const GiftMenu=(props)=>{
       ...
       const closelocmenu=()=>{
        ...
        document.getElementById('giftmenu').classList.add('hidden')
    ...
    return(
        ...
        <div  className="loc-menu top-0 left-0 bg-dark fixed w-full h-full overflow-scroll" style={
            {
                                                ...
                                                loc.cities.map((item)=>{
                                                    ...
                                                    return(
                                                        <div key={loc.id+item.id} className=' loc-item py-2 border-b border-dark-coffee'>
                                                                    ...
                                                                    <a href={"/"+item.slug+"/gift-cards"} className='loc-link'> 
