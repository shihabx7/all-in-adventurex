...
const OtherHero=(props)=>{
    ...
    return(
        <div className='other-home-hero relative overflow-hidden' style={
            {
            ...
            <div className='max-w-7xl  mx-auto px-4 pt-16 pb-16 md:py-20 lg:py-32 xl:py-40 relative z-10'>
                <div className="page-benar-info"> 
                 ...
                 <p className='text-[#333333] max-w-2xl mx-auto text-center lg:text-lg'>{props.pagedata.pagesubtitle } </p>
                 </div>
