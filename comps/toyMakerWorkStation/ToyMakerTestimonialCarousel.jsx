...
const ToyMakerTestimonialCarousel = ({ testimonialList }) => {
  const responsive = {
    desktop2xl: {
  ...
  return (
    <div className="full-carousel planning-event-carousel inp-car ev-car mer-car tw-test-car">
      <Carousel
        swipeable={true}
        draggable={true}
        showDots={true}
...
export default ToyMakerTestimonialCarousel;
