  ...
  return (
    <div className="what-is-rewards-section bg-[#090909]">
      <div className="section-container max-w-7xl mx-auto py-16 md:py-20 lg:py-28 px-4">
        <div className="section-content flex flex-col md:flex-row space-y-10 md:space-y-0 justify-between items-center ">
          <div className="text-content max-w-[420px]">
            <div>
              <p className="text-red-700 md:text-lg ">The Program</p>
              <h2 className="text-2xl rm:text-[1.75rem]  md:text-[2.5rem] lg:text-[2.875rem] leading-[1.2] font-os font-bold text-[#E0BF62] mt-3 md:mt-5 lg:mt-6">
                <span className="text-[#F0E8D5] block">WHAT IS</span>
                <span className="block">ALL IN REWARDS?</span>
              </h2>
              <p className="text-white xl:text-lg mt-4 md:mt-6">
            ...
            <div className="booking-btn md:max-w-[360px] mt-10">
              <UnlockRewardBtn />
            </div>
          </div>
          {/*=====================================================content-box */}
          <div className="text-content max-w-[672px] flex flex-col space-y-8">
            <div className="wr-box p-4 md:p-5 lg:p-7 border-l-[3px] border-[#8A7133] bg-gradient-to-r from-[#19160E] via-[#19160E]/10 to-transparent">
              <h3 className="font-os text-[#F0E8D5] text-2xl font-semibold">
                All In Rewards
              </h3>
