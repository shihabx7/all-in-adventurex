...
export default function AllinRewardBaner() {
  return (
    <div className="all-in-reward-baner-section relative bg-[#090909]">
      <div className="section-container max-w-[700px] lg:max-w-7xl mx-auto pb-16 pt-2 md:py-20 lg:py-28 px-4 lg:px-8 2xl:px-4">
        <div className="section-row flex flex-col lg:flex-row justify-between space-y-0 lg:space-y-0 lg:space-x-4 items-center">
          <div className="section-content w-full lg:w-[48%] order-2 lg:order-1">
            <div>
              <h2 className="hidden lg:block text-2xl rm:text-[1.75rem]  md:text-[2.5rem] lg:text-[2.875rem] leading-[1.2] font-os font-bold text-[#E0BF62] uppercase mt-6">
                <span className="text-[#F0E8D5] block">
                  Unlock Free Rooms with
                </span>
                <span className="block">ALL IN Rewards!</span>
              </h2>
              <p className="text-white xl:text-lg mt-6 text-center lg:text-left">
            ...
            <div className="btn-pair flex flex-col md:flex-row md:justify-center lg:justify-start items-center space-y-5 sm:space-y-0 sm:space-x-4 mt-8 md:mt-10 lg:mt-12">
          ...
          {/*====================section img */}
          <div className="section-img w-full lg:w-[45%] order-1 lg:order-2">
            <div  className="lg:hidden text-center">
               <h2 className=" text-2xl rm:text-[1.75rem]  md:text-[2.5rem] lg:text-[2.875rem] leading-[1.2] font-os font-bold text-[#E0BF62] uppercase mb-6">
                <span className="text-[#F0E8D5] block">
                  Unlock Free Rooms with
                </span>
                <span className="block">ALL IN Rewards!</span>
