...
const ModalBookingMenu = ({ locationSlugList, activeBooking }) => {
  ...
  return (
    <>
      ...
      <div
        className="bundle-booking-loc-menu top-0 left-0 bg-dark fixed w-full h-full overflow-scroll md:overflow-hidden z-[100000]"
        style={{
          backgroundImage:
