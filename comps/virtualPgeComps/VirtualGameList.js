                                ...
                                <div className="all-game-list-head flex justify-between">
                                 ...
                                 <div className="all-game-list-bottom">
                                        <div className=" text-center md:text-left">
                                         ...
                                         <div className="card-game-link mt-4 text-left">
                                             <a target={"_blank"} href={vgame.bookinglink} className="text-center border-2 w-[240px]  block md:inline-block mx-auto md:mx-0 border-red-600 bg-red-600 py-2 md:py-3 px-12 rounded-full font-medium text-lg mb-4 hover:bg-red-700 hover:border-red-700 text-white">BOOK NOW</a>
