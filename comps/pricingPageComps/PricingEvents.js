...
const PricingEvents = () => {
  return (
    <div
      className="events-pricing relative bg-center bg-cover"
      ...
      <div className="section-container max-w-7xl mx-auto  pb-16 md:pb-20 lg:pb-28 relative z-30">
            ...
            <tbody className="bg-[#FBF2DC]">
              ...
              <tr>
                <td className="border border-[#D2C6AA] w-[36%] md:w-[35%] p-2 md:p-4 text align-top">
                  <h4 className="my-2 leading-[1.5] text-sm md:text-[20px] text-[#222222]">
                    Birthday Party
                  </h4>
                  <h4 className="my-2 leading-[1.5] text-sm md:text-[20px] text-[#222222]">
                    Team Building{" "}
                  ...
                  <h4 className="my-2 leading-[1.5] text-sm md:text-[20px] text-[#222222]">
                    And Others Private Events
                  </h4>
                </td>
                <td className="border border-[#D2C6AA] w-[32%] md:w-[32%] p-2 md:p-4 align-top">
                  <h4 className="mt-2 font-light text-xs sm:text-sm md:text-[20px] text-[#000000]">
                    {" "}
                    <span className="font-medium">$75.00</span> + Tax / Guests
                  </h4>
                  <ul className="star-list list-inside md:list-outside mt-4 md:pl-5">
                    <li className="my-2 md:my-3 text-xs sm:text-sm lg:text-lg font-light">
                      Party room rental for 2 hours
                    </li>
                    <li className="my-2 md:my-3 text-xs sm:text-sm lg:text-lg font-light">
                      Bring your own store bought food
                    </li>
                    <li className="my-2 md:my-3 text-xs sm:text-sm lg:text-lg font-light">
                      Basic supplies (plates, napkins, utensils, etc.)
                    </li>
                    <li className="my-2 md:my-3 text-xs sm:text-sm lg:text-lg font-light">
                      FREE All In Adventures birthday invitations (digital - can
                      be printed)
                    </li>
                    <li className="my-2 md:my-3 text-xs sm:text-sm lg:text-lg font-light">
                      $30 gift card for birthday child
                    </li>
                  </ul>
                </td>
                <td className="border border-[#D2C6AA] w-[32%] md:w-[32%] p-2 md:p-4 align-top">
                  <h4 className="mt-2 font-light text-xs sm:text-sm md:text-[20px] text-[#000000]">
                    {" "}
                    <span className="font-medium">$19.99</span> / Guests (Min.
                    Count: 6 Guests)
                  </h4>
                  <ul className="star-list mt-4 pl-5">
                    <li className="my-3 text-xs sm:text-sm lg:text-lg font-light">
                      Party room rental for 2 hours
                    </li>
                    <li className="my-3 text-xs sm:text-sm lg:text-lg font-light">
                      Food includes pizza, cookie cake, and a drink for each
                      guest
                    </li>
                    ...
                    <li className="my-3 text-xs sm:text-sm lg:text-lg font-light">
                      $35 gift card for birthday child
                    </li>
                  </ul>
                </td>
              </tr>
        ...
        <div className="pricing-notice max-w-[800px] px-4 mx-auto mt-4 md:mt-8">
          <div className="view-all flex justify-center ">
            ...
            >
              <span>View all events</span> <FiChevronRight />
            </a>
          </div>
        </div>
