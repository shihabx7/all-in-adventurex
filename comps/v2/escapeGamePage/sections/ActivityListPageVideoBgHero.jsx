import ActivityListPageHeroVideoBg from "../ActivityListPageHeroVideoBg";
import PageTitleCenterLight from "../PageTitleCenterLight";
import PageHeroInfo from "../HomeHeroInfo";
import HomeHeroInfo from "../HomeHeroInfo";
import PageHeroLocBtn from "../PageHeroLocBtn";

export default function ActivityListPageVideoBgHero({
  pageHeroData,
  allBooking,
}) {
    ...
    <div className="page-hero-section">
      <div className="section-bg  bg-stone-800 relative">
        <div className="hero-video-bg w-full h-full absolute top-0 left-0 ">
          <ActivityListPageHeroVideoBg videoData={pageHeroData.heroBgVideo} />
        </div>
        ...
        <PageHeroInfo heroInfo={pageHeroData.heroInfo} />
      </div>
    </div>
  );
}
