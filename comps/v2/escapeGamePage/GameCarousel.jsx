...
export default function GameCarousel({ gameCarouselData }) {
  const responsive = {
    desktop: {
              ...
              <div className="carousel-btn-pair mt-5 mb-2">
                <div className="flex justify-center items-center space-x-2 md:space-x-3 lg:space-x-5 ">
                  <button
                    ...
                    className="block max-w-[150px] border-[2px] border-red-600 rounded-full bg-red-600 hover:bg-red-700 hover:border-red-700 text-[15px] md:text-[16px] xl:text-[18px] leading-[1.1] text-white px-5 rm:px-6 py-[11px] xl:py-[13px] text-center font-medium transition duration-400 ease-in-out"
                  >
                    BOOK NOW
                  </button>
                  <a
                    href={`/activities/${item.slug}`}
                    className="block max-w-[150px] border-[2px] border-red-600 rounded-full bg-transparent hover:bg-red-700 hover:border-red-700 text-[15px] md:text-[16px] xl:text-[18px] leading-[1.1] text-[#ffffff] hover:text-white px-5 rm:px-6 py-[10px] xl:py-[12px]  text-center font-medium transition duration-400 ease-in-out"
                  >
                    EXPLORE
                  </a>
                </div>
