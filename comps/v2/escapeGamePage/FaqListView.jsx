...
export default function FaqListView({ faqList }) {
          ...
          <div key={index} className="faq-panel">
            ...
            >
              <div className="faq-ques-title flex space-x-1 md:space-x-2 ">
                <div className=" block text-[#E0BF62] group-hover:text-[#A17533] text-2xl md:text-4xl font-medium">
                  Q.{" "}
                </div>
                <div className="text-[#C7C7C7] group-hover:text-[#A17533] block font-medium  mt-[6px] md:mt-[10px] lg:mt-[6px] text-[17px] md:text-[20px] lg:text-[22px]">
                  {item.question}{" "}
                </div>
              </div>
            ...
            <div className="faq-a text-white border-b-[1px] border-[#D9CDB6]">
              {faqAns == index && (
                <div className="faq-ans-box  py-6 px-2 md:px-4 lg:px-6 flex space-x-1 md:space-x-2 ">
                  ...
                  <div className="text-[16px] md:text-[18px] xl:text-[19px] mt-2 md:mt-3 text-[#A2A3A3]">
                    <div
