  ...
  return (
    <div className="note-to-remember-section relative">
      ...
      <div className="section-wrapper relative bg-[#370202]/80 z-20">
        <div className="section-container max-w-[700px] lg:max-w-7xl mx-auto py-16 md:py-20 lg:py-[9rem] xl:py-32 2xl:py-[10rem] px-3 zm:px-4">
          <div className="section-row flex flex-col lg:flex-row lg:space-x-2 lg:justify-between items-center">
            <div className="section-col order-2 lg:order-1 max-w-[640px] lg:max-w-[500px] xl:max-w-[576px] 2xl:max-w-[600px]">
              <div className="section-text">
                ...
                <h1 className="ev-ibrew text-[#FFFFFF] font-semibold tracking-widest shadow-lg uppercase font-os my-2">
                  {pageHeroData && pageHeroData.eyeBrewText
                    ? pageHeroData.eyeBrewText
                    : "Escape Room parties & events "}
                </h1>
                <h2 className="uppercase text-white text-3xl md:text-[2.875rem] xl:text-[2.9rem] 2xl:text-[3rem] leading-[1.2] font-os font-semibold  my-2 md:my-2 lg:my-3">
