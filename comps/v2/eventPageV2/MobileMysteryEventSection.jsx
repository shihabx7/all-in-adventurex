  ...
  return (
    <div className="eventpage-mbl-mystery-section bg-[#231800] relative">
      <div className="section-container min-h-[50vh] max-w-[860px] lg:max-w-7xl py-16 md:py-20 lg:py-28 px-3 xl:px-6 mx-auto">
        <div className="section-title mb-6 rm:mb-8 md:mb-10 lg:mb-12 max-w-[960px] ">
          <h2 className="text-[#E0BF62] pt-0 md:py-2 text-[1.5rem] md:text-[2.5rem] xl:text-[2.6rem] 2xl:text-[2.7rem] leading-[1.25] font-os font-bold uppercase">
            {sectionData.sectionTitle
              ? sectionData.sectionTitle
              : "Can't Come to Us? We'll Bring the Adventure to You."}
          </h2>
          <p className=" text-[#B5B5B5] mt-2 md:mt-3 md:text-lg lg:text-xl ">
