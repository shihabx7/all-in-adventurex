...
export default function MobileEventCard({ locationSlug }) {
    ...
    <div className="escape-game-list-container  lg:max-w-7xl mx-auto  mt-8 md:mt-10 lg:mt-12">
      ...
      <div className="ogl-info-row flex justify-center flex-col lg:flex-row space-y-8 lg:space-y-0 lg:space-x-5 xl:space-x-8">
        <div className="ogl-item-col w-full relative shadow-golden">
          ...
          <div className="ogl-info-content relative z-[30] p-2 rm:p-2  zm:p-4 md:p-6  xl:p-8">
            ...
            <div className="list-card-gap h-[110px] rm:h-[130px] md:h-[200px]"></div>
            {/*=========================================game  decription====*/}
            <div className="bottom-section md:max-w-[520px] lg:max-w-[700px]">
              ...
              <div className="egl-shot-desc mt-2 md:mt-2 xl:mt-3">
                <p className="text-[#E5E7EB] text-sm lg:text-base 2xl:text-lg">
                  A fully hosted, portable Mobile Mystery escape game featuring
                  real props, digital locks, engaging storytelling, and live
                  guidance from our Game Master—brought straight to your
                  location. See{" "}
                  <a
                    className="text-red-600 hover:text-red-700"
                    href={
                      locationSlug
                        ? "/" + locationSlug + "/activities/mobile-escape-room"
                        : "/mobile-escape-room"
                    }
                  >
                    how it works
