      ...
      <div className="section-head px-3 rm:px-4">
        ...
        <div className="page-sub-title max-w-[700px] lg:max-w-[800px] mx-auto">
          <p className="text-[#f3f4f6]  sm:text-lg xl:text-xl text-center mt-3 md:mt-3 lg:mt-4 xl:mt-5">
            ...
            filled with teamwork and excitement. Digital gift cards never expire
            and are redeemable at all our locations.
          </p>
        </div>
      </div>
      {/*============section head end==========*/}
      <div className="escape-game-list-container  px-3 rm:px-4  lm:max-w-[380px]  zm:max-w-[500px] md:max-w-[760px]  lg:max-w-[960px] xl:max-w-[1180px] 2xl:max-w-[1200px] mx-auto  mt-8 md:mt-10 lg:mt-12">
        {/*============mob myster  card==========*/}
