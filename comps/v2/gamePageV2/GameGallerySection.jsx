import GameGalleryCarousel from "./elements/GameGalleryCarousel";
export default function GameGallerySection({ sectionData }) {
  return (
    <div className="game-gallery-section bg-[#090909] relative">
      <div className="section-container min-h-[50vh] max-w-[840px] lg:max-w-7xl py-16 md:py-20 lg:py-28 px-4 xl:px-6 mx-auto">
        <div className="section-title mb-6 rm:mb-8 md:mb-10 lg:mb-12 max-w-[930px] mx-auto">
          ...
          <p className=" text-[#B5B5B5] mt-2 md:mt-3 lg:mt-4 text-center md:text-lg lg:text-xl md:max-w-[720px] lg:max-w-[1000px] mx-auto">
        ...
        <div className="lg:hidden">
          <GameGalleryCarousel imageList={sectionData.galleryImages} />
        </div>
      </div>
    </div>
  );
