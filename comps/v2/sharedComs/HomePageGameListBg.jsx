  ...
  return (
    <div className="escape-game-list-section-wrapper bg-[#090909]">
      <div className="dt-section-wrapper pt-20 pb-16 zm:pt-[7.5rem]  md:py-20 lg:py-24 xl:py-28  relative">
        ...
        <div className="section-content flex flex-col space-y-16 md:spcae-y-20 lg:space-y-24 xl:space-y-28  relative z-20">
          {children}
        </div>
        <div className="bottom-img-gap h-[16px] rm:h-[20px] md:h-[90px] lg:h-[120px] xl:h-[160px] 2xl:h-[192px] 3xl:h-[250px] 4xl:h-[270px]"></div>
        <div className="animated-maze-bg w-full absolute bottom-0 left-0 right-0 mx-auto ">
          {/*========== =========================================maze img*/}
          ...
          <div className="maze-img relative w-full overflow-hidden">
            <img
              ...
              src="/assets/home-page/allinadventures-escape-room-compass-bg.jpg"
            ></img>
          </div>
        </div>
      </div>
