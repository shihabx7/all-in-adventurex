                    ...
                    <div className="partner-row flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 lg:space-x-8 justify-center ">
                        ...
                        <div className="partner-item bg-[#111111] px-4 py-4 rounded-md md:w-1/3">
                            ...
                            <div className="p-desc mt-2 text-center">
                                ...
                                <a href="https://www.usatoday.com/" target="_blank" className="flex space-x-1 justify-center items-center text-red-600 text-lg">
                        ...
                        <div className="partner-item bg-[#111111] px-4 py-4 rounded-md md:w-1/3">
                            ...
                            <div className="p-desc mt-2 text-center">
                                ...
                                <a href="https://www.cnbc.com/video/2019/04/24/experience-over-shopping-making-malls-hot-again.html" target="_blank" className="flex space-x-1 justify-center items-center text-red-600 text-lg">
                                <span>Learn more</span><span><FiChevronRight/></span>
                                </a>
                            </div>
                        </div>
                        <div className="partner-item bg-[#111111] px-4 py-4 rounded-md md:w-1/3">
                            ...
                            <div className="p-desc mt-2 text-center">
                                ...
                                <a href="https://www.youtube.com/watch?v=vA9KHQ0Biqw" target="_blank" className="flex space-x-1 justify-center items-center text-red-600 text-lg">
                                <span>Learn more</span><span><FiChevronRight/></span>
                                </a>
                            </div>
                        </div>
                     ...
                     <div className="partner-row flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 lg:space-x-8 justify-center  mt-4 lg:mt-8">
                        ...
                        <div className="partner-item bg-[#111111] px-4 py-4 rounded-md md:w-1/3">
                            ...
                            <div className="p-desc mt-2 text-center">
                                ...
                                <a href="https://www.mycentraljersey.com/story/money/business/2019/10/29/all-in-adventures-escape-room-opens-brunswick-square-mall-nj/2484647001/" target="_blank" className="flex space-x-1 justify-center items-center text-red-600 text-lg">
                                <span>Learn more</span><span><FiChevronRight/></span>
                                </a>
                            </div>
                        </div>
                        <div className="partner-item bg-[#111111] px-4 py-4 rounded-md md:w-1/3">
                            ...
                            <div className="p-desc mt-2 text-center">
                                ...
                                <a href="https://westfieldsouthwick.macaronikid.com/articles/59b173763c105d76b6e2f315/have-you-escaped-yet" target="_blank" className="flex space-x-1 justify-center items-center text-red-600 text-lg">
                                <span>Learn more</span><span><FiChevronRight/></span>
                                </a>
                            </div>
                        </div>
                        <div className="partner-item bg-[#111111] px-4 py-4 rounded-md md:w-1/3">
                            ...
                            <div className="p-desc mt-2 text-center">
                                ...
                                <a href="https://www.dailyitem.com/business/escape-rooms-allows-valley-residents-to-escape-into-an-alternate/article_ea772444-96e7-11e7-9549-8fcb321a40b8.html" target="_blank" className="flex space-x-1 justify-center items-center text-red-600 text-lg">
                                <span>Learn more</span><span><FiChevronRight/></span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="partner-row flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 lg:space-x-8 justify-center  mt-4 lg:mt-8">
                            ...
                            <div className="partner-item bg-[#111111] px-4 py-4 rounded-md md:w-1/3">
                                ...
                                <div className="p-desc mt-2 text-center">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=xuMg3rYggGA" target="_blank" className="flex space-x-1 justify-center items-center text-red-600 text-lg">
                                    <span>Learn more</span><span><FiChevronRight/></span>
                                    </a>
                                </div>
                            </div>
