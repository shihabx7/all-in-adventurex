...
const DealsFaqs = (props) => {
  return (
    <div className="reward-faq relative bg-black py-16 md:py-24 lg:py-32 px-4 overflow-hidden">
      ...
      <div className="max-w-[990px] mx-auto relative z-30 red-link p1-gap">
        ...
        <div className="gl-bottom-link mt-12 text-center">
          <a
            href="/faqs"
            className="flex text-lg justify-center space-x-1 font-medium items-center text-red-600 hover:text-red-700"
          >
