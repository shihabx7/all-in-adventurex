                            ...
                            <div className="faq-a text-white">
                                {
                                    ...
                                    <div className="faq-ans-box bg-[#111111] py-6 px-2 md:px-4 lg:px-6 flex space-x-1 md:space-x-2 ">
                                        <span className="golden-text text-2xl md:text-4xl font-medium">A. </span> 
                                        <span className="text-[16px] md:text-[18px] lg:text-[20px] mt-2 md:mt-3 text-[#b5b5b5]">{item.ans} </span>
