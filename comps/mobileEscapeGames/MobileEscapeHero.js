            ...
            <div className="mbl-h-btn  mt-8 md:mt-10 2xl:mt-12">
              {locationSlug ? (
                <button
                  ...
                  className="max-w-[280px] px-12 md:px-14 py-[14px] md:py-4 text-center border block text-white border-red-600 bg-red-600  rounded-full font-semibold md:text-lg hover:bg-red-700 hover:border-red-700"
                >
                  GET A QUOTE
                </button>
              ) : (
