...
const MobileEscapeGallery = ({ imgList }) => {
  const responsive = {
    desktoplg: {
    ...
    <div className="game-gallery bg-[url('/assets/svg/pattern/Light-Brown-Color-BG-Pattern.svg')] bg-center bg-repeat bg-[length:360px_360px] md:bg-[length:580px_580px] lg:bg-[length:640px_640px]">
      <div className="max-w-7xl mx-auto py-16 md:py-20 lg:py-28 px-4">
        <div className="s-title">
          <TitleSeparator title={"MOBILE ESCAPE ROOM GALLERY"} />
          <div className="max-w-[800px] mx-auto mt-4 mb-4 md:mt-6  lg:mb-10 3xl:mb-12">
            <p className="text-gray-700 px-4 md:px-6  md:text-lg 3xl:text-xl text-center">
              Explore our vibrant gallery showcasing the fun, immersive
              experiences and exciting themes of our mobile escape rooms!
            </p>
          </div>
        </div>
