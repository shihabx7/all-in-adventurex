...
export default function TestimonialCarouselMm ({ testimonialList }) {
  const responsive = {
    desktop2xl: {
  ...
  return (
    <div className="full-carousel planning-event-carousel inp-car ev-car mer-car">
      <Carousel
        ...
        ssr={true} // means to render carousel on server-side. mer-car
        infinite={true}
        ...
        itemClass="game-carousel-card   px-2 sm:px-3 md:px-4 lg:px-3 xl:px-4 2xl:px-5 py-4 md:py-6 lg:py-8"
