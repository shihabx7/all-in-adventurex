...
const MobileEscapePricing = ({ pricingSectionData, locationName }) => {
  return (
    <div className="bg-[#251A03]">
      <div className="max-w-7xl mx-auto mt-[-40px] rm:mt-[-80px] md:mt-[-100px]  lg:mt-[-110px] xl:mt-[-106px] 2xl:mt-[-112px]  relative z-30 px-4 md:px-3 xl:px-4 2xl:px-0">
              ...
              >
                <div className="item-wrapper px-4 py-6 rm:px-5 rm:py-8 md:px-3 md:py-6 lg:px-5 lg:py-7 xl:px-6 2xl:px-7 2xl:py-8">
                  <div className="mar-wv-text ">
                    ...
                    <p className="text-[#CA9342] mt-4 md:mt-3 lg:mt-4 3xl:mt-5 text-sm rm:text-[16px] md:text-[14px] lg:text-[15px]  xl:text-base 3xl:text-lg font-semibold leading-1 ">
                      {item.subTitle}{" "}
