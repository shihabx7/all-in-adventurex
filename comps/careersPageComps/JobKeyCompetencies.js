const JobKeyCompetencies = (props) => {
  return (
    <div className="job-roles-notice">
      ...
      <div className="abt-notice mt-4 md:mt-6 lg:mt-6 text-lg">
        {props.keyCompetencies.map((item, index) => {
          return (
            <div
              key={index + 1}
            ...
            >
              ...
              <div className="w-[94%] lg:text-lg">{item.competencies}</div>
            </div>
          );
        })}
      </div>
...
export default JobKeyCompetencies;
