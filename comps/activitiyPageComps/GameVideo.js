        ...
        <div className="game-video relative" style={{backgroundImage : "url('/assets/game-dt-bg.jpg')", }}> 
            <div className="max-w-7xl mx-auto pb-16 md:pb-20 lg:pb-28 px-4 relative z-30"> 
                ...
                <div className="game-b-btnbox mt-8 md:mt-16 lg:mt-20">
                        {
                            props.gamelocation_slug?
                            <div className="game-btn-all ">
                            <Link href={props.gamelocation_slug+"/activities/"} hpassHref>
                            ...
                            <Link href={props.gamelocation_slug+"/gift-cards/"} hpassHref>
                                <a className="max-w-[260px] md:max-w-[280px] my-4 block mx-auto uppercase py-3 md:py-4 px-6 text-lg text-[#424242] hover:text-white font-medium border-2 border-red-600 hover:border-red-700 hover:bg-red-700 rounded-full text-center">Buy Gift Card</a>
                             </Link>
                        </div>
                             :
                             <div className="game-btn-all ">
                                 ...
                                 <Link href="/gift-cards/" hpassHref>
                                     <a className="max-w-[260px] md:max-w-[280px] my-4 block mx-auto uppercase py-3 md:py-4 px-6 text-lg text-[#424242] hover:text-white font-medium border-2 border-red-600 hover:border-red-700 hover:bg-red-700 rounded-full text-center">Buy Gift Card</a>
                                  </Link>
                             </div>
