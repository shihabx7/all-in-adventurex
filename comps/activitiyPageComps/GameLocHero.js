            ...
            <div className='max-w-7xl home-hero-container mx-auto px-4 pt-0 pb-20 md:py-20 lg:py-32 xl:py-40 relative z-20'>
                ...
                <div className="max-w-md mx-auto mt-8 ">
                        ...
                        {/*============location search btn==========*/}
                        {
                            ...
                            <button onClick={()=>bookAll(props.pagedata.bookingall)} className="block w-full py-3 rounded-full text-center text-white font-medium border-2 border-red-600 bg-red-600 hover:border-red-700 hover:bg-red-700 text-lg">BOOK YOUR GAMES</button>
                        }
                         {
                        ...
                        }
                        {
                        ...
                        }
                         {
                            ...
                            <>
                            {props.pagedata.eventbooking.eventstatus==true &&
                             <a  href={"/"+props.pagedata.locationslug+"/events" }className="w-full block mt-4 py-3 rounded-full text-center text-white font-medium border-2 border-red-600 hover:bg-red-700 hover:border-red-700 text-lg">VIEW ALL EVENTS</a>
                            }
                            {props.pagedata.eventbooking.eventstatus==false &&
                             <a  href={"/"+props.pagedata.locationslug+"/events" }className="w-full block mt-4 py-3 rounded-full text-center text-white font-medium border-2 border-red-600 hover:bg-red-700 hover:border-red-700 text-lg">VIEW ALL EVENTS</a>
                            }
                ...
                <div style={{
                    ...
                    }
                    {
                        ...
                        <div className="text-center">  
                             ...
                             <p className="text-gray-700 text-xs md:text-base lg:text-lg ">{props.pagedata.max_players<2? "player":"Players"}{props.pagedata.groupcat && <span className="text-[10px] md:text-[16px]">/{props.pagedata.groupcat}</span> }</p>
                          </div>
                    }
