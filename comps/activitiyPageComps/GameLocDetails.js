...
const GameLocDetails = (props) => {
  return (
    ...
    >
      ...
      <div className="content-container-game  pt-16 md:pt-24 lg:pt-32 px-4 relative z-30">
        {/*=========== game story=====*/}
        ...
        <div className="game-dt-container mission-bg relative">
          <div className="msn-bg-l absolute top-[40%] right-[-10px] md:left-0 md:top-[-160px] lg:top-[-120px] xl:top-[-140px] 2xl:top-[-120px]  z-20">
            <img
              className=" -scale-x-100 md:scale-x-100 w-[120px] md:w-[140px] lg:w-[170px] xl:w-[200px] xl:opacity-80 2xl:w-[320px] 2xl:opacity-90"
              src="/assets/svg/game-bg-pattern/direction.svg"
            ></img>
          </div>
          <div className="msn-bg-r absolute bottom-[-100px]  right-[-10px] md:bottom-[-80px] md:right-[0px] lg:bottom-[-120px] lg:right-[-10px] xl:bottom-[-130px] xl:right-[-10px] 2xl:bottom-[-180px] 2xl:right-[120px] z-20">
            <img
