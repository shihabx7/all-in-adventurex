          ...
          <div className="max-w-7xl home-hero-container mx-auto px-4 pt-0 pb-20 md:py-20 lg:py-32 xl:py-40 relative z-10">
            ...
            <div className="max-w-md mx-auto mt-8 ">
              ...
              <a
                ...
                className="block mt-4 w-full py-3 rounded-full text-center text-white font-medium border-2 border-red-600 bg-transparent hover:border-red-700 hover:bg-red-700 text-lg"
              >
                VIEW ALL GAMES{" "}
              </a>
