        ...
        <div className="s-title">
          ...
          <div className="max-w-2xl md:text-lg mx-auto text-center mt-4 md:mt-8 mb-4 md:mb-16">
            <p className="text-gray-700 md:px-8">
              ...
              our {props.activityname && <span>{props.activityname}</span>}
              {!props.activityname && <span>Allinadventure</span>}
              {props.category == "other" ? "" : " escape game"}. Experience this
              game at All In Adventures.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {props.galleryitem.map((item) => {
              return (
                ...
                >
                  <img src={item.img} alt={item.img_alt}></img>
                </div>
              );
            })}
          </div>
