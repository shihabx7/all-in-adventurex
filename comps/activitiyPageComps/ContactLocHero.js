                ...
                <div className="max-w-md mx-auto mt-8 ">
                        ...
                        }
                        {
                            ...
                            }
                            {
                                ...
                                <a href="#eventform" className="block mt-4 py-3 rounded-full text-center text-white font-medium border-2 border-red-600 hover:bg-red-700 hover:border-red-700 text-lg">BOOK YOUR PARTY</a>
                            }
                            </>
                        }
                        {
