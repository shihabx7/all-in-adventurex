                                                ...
                                                <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between ">
                                                    ...
                                                    <div className="form-col w-full md:w-[49%] lg:w-[49%]">
                                                        ...
                                                        required>
                                                           ...
                                                           {
                                                        formErr.lNameErr &&
                                                        <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr">Invalid name. Only letter and space allowed (min 3 character)</p>
                                                    }
                                                    </div>
                                                </div>
                                         ...
                                         {/*======================================contact form Email+ Phone====================== */}
                                               ...
                                               <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between ">
                                                    ...
                                                    <div className="form-col w-full md:w-[49%] lg:w-[49%]">
                                                        ...
                                                        {
                                                                 formErr.stateErr &&
                                                                 <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr ">Select your state</p>
                                                             }
                                                    </div>
                                                </div>
                                                        ...
                                                        {/*======================================contact form row What's your current net worth?===================== */}
                                                            <div className="form-row flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between ">
                                                                <div className="form-col md:w-[49%] lg:w-[49%]">
                                                                    ...
                                                                    {
                                                                     formErr.netWorthErr &&
                                                                    <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr ">Invalid net worth</p>
                                                                     }
                                                                ...
                                                                <div className="form-col md:w-[49%] lg:w-[49%]">
                                                                    ...
                                                                    <input type="text"
                                                                       ...
                                                                       {
                                                                     formErr.liqAssetErr &&
                                                                    <p className="cor-form-err mt-1 evevt-input-label text-[#E1001A] fErr ">Invalid liquid assets</p>
                                                                     }
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <input type="date"
                                                                     ...
                                                                     onChange={(e)=>getPreferredTimefame(e)} 
                                                                      ...
                                                                      required></input>
                                                                        {
                                                                            formErr.pTimeErr &&
                                                                            <p className="cor-form-err md:absolute md:left-0 md:top-[100%] mt-1 evevt-input-label text-[#E1001A] fErr ">Invalid date</p>
                                                                        }
                                                                </div>
                                                                <div className="form-col md:w-[49%] lg:w-[49%]">
                                                                    ...
                                                                    {
                                                                            formErr.otherFErr &&
                                                                            <p className="cor-form-err md:absolute md:left-0 md:top-[100%] mt-1 evevt-input-label text-[#E1001A] fErr ">Select Answer</p>
                                                                        }
                                                                </div>
                                                            </div>
