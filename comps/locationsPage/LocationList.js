                  ...
                  {props.locationListData.locationList.map((state) => {
                    return (
                      <button
                        ...
                        className="bg-[#1c1c1c] flex-1 hover:text-gold hover:bg-[#111] focus:text-gold focus:bg-[#111] py-3 px-1 md:px-1 text-sm md:text-base lg:text-lg text-[#7b7b7b] min-w-[96px] md:min-w-[102px]"
                      >
                        {state.stateCode}
