...
export const escapeGameData = {
  "escape-from-alcatraz": {
    ...
    gameInfo: {
      ...
      successRate: "64",
      price: "26.99",
      gameTheme: ["Adventure", "Thriller", "Story Driven", "Historical"],
      recommendFor: ["Birthday Party", "Team Building"],
    ...
    gameCardData: {
      ...
      video: {
        webmUrl:
          "/assets/escape-games/videos/webm/escape-from-alcatraz-escape-game.webm",
        url: "/assets/escape-games/videos/mp4/escape-from-alcatraz-escape-game.mp4",
        width: "",
        height: "",
      },
      cardBgImage: {
        url: "/assets/escape-games/card-bg/all-in-adventures-escape-from-alcatraz-card-bg.png",
        alt: "all in adventures escape game escape from alcatraz card bg",
        width: "794",
        height: "509",
      },
  ...
  "treasure-island": {
    ...
    gameInfo: {
      ...
      successRate: "72",
      price: "26.99",
      gameTheme: ["Adventure", "Fantasy", "Beginner-Friendly"],
      recommendFor: ["Birthday Party", "Team Building"],
      storyLineTitle: "Breakout or Bust!",
      storyLine:
        "<p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful. As guards in the nation's strongest prison, it is your duty to uphold Alcatraz's stalwart reputation.</p><p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful.</p>",
    ...
    gameCardData: {
      ...
      video: {
        webmUrl:
          "/assets/escape-games/videos/webm/treasure-island-escape-game.webm",
        url: "/assets/escape-games/videos/mp4/treasure-island-escape-game.mp4",
        width: "",
        height: "",
      },
      cardBgImage: {
      ...
      text: "Captured by pirate Captain Hawkins and you have 60 minutes to prove your sea-worthiness and either join his crew, or face the sharks. Navigate the ship, follow orders, and demonstrate your skills. Will you survive and join the fearsome crew, or meet a watery end?",
    },
    seoData: {
      metaTitle: "Escape From Alcatraz Escape Room | All In Adventures",
      metaDescription:
  ...
  "zombie-apocalypse": {
    ...
    gameCardData: {
      ...
      video: {
        webmUrl:
          "/assets/escape-games/videos/webm/zombie-apocalyps-escape-game.webm",
        url: "/assets/escape-games/videos/mp4/zombie-apocalyps-escape-game.mp4",
        width: "",
        height: "",
      },
      cardBgImage: {
      ...
      text: "Trapped in an Umbra Industries lab, you face a zombie outbreak. Find the key card, create a vaccine in 60 minutes, and lift the lockdown to escape! Save yourselves and the world, or join the horde as the facility seals forever.",
    },
    seoData: {
      metaTitle: "Escape From Alcatraz Escape Room | All In Adventures",
      metaDescription:
  ...
  "sherlocks-library": {
    ...
    gameInfo: {
      ...
      successRate: "72",
      price: "26.99",
      gameTheme: ["Espionage", "Survival", "Story Driven", "High Stakes"],
      recommendFor: ["Team Building"],
      storyLineTitle: "Breakout or Bust!",
      storyLine:
        "<p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful. As guards in the nation's strongest prison, it is your duty to uphold Alcatraz's stalwart reputation.</p><p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful.</p>",
    ...
    gameCardData: {
      ...
      video: {
        webmUrl:
          "/assets/escape-games/videos/webm/sherlocks-library-escape-game.webm",
        url: "/assets/escape-games/videos/mp4/sherlocks-library-escape-game.mp4",
        width: "",
        height: "",
      },
      cardBgImage: {
      ...
      text: "Sherlock Holmes is missing! Investigate the suspects' accountant. Be careful - he'll return to his office in just 60 minutes! Uncover his deception, find Sherlock's clues, and identify the culprits before the accountant returns. Can you save Holmes?",
    },
    seoData: {
      metaTitle: "Escape From Alcatraz Escape Room | All In Adventures",
      metaDescription:
  ...
  "black-ops": {
    ...
    gameCardData: {
      ...
      video: {
        webmUrl: "/assets/escape-games/videos/webm/black-ops-escape-game.webm",
        url: "/assets/escape-games/videos/mp4/black-ops-escape-game.mp4",
        width: "",
        height: "",
      },
      cardBgImage: {
        url: "/assets/escape-games/card-bg/all-in-adventures-black-ops-card-bg.png",
        alt: "all in adventures escape game black ops card bg",
        width: "794",
        height: "509",
      },
      text: "Capture The Hawk - but the bunker's a trap! You have 60 minutes to disarm a bomb and secure intel before it explodes and enemies arrive. Escape with the information and your lives, or become another victim of The Hawk's game.",
    },
    seoData: {
      metaTitle: "Escape From Alcatraz Escape Room | All In Adventures",
      metaDescription:
  ...
  "superheros-adventure": {
    ...
    activeAll: true,
    pageHeroData: {
      pageTitle: "Superhero's Adventure ESEscape Room",
      pageSubTitle:
        "<p>You've been captured by a notorious gang of pirates. Prove you're worthy of becoming part of the crew or prepare to walk the plank!</p>",
      heroBgVideo: {
        video: {
    ...
    gameInfo: {
      ...
      successRate: "72",
      price: "26.99",
      gameTheme: ["Adventure", "Quirky", " Kid Favorite", "Beginner-Friendly"],
      recommendFor: ["Birthday Party", "Team Building"],
      storyLineTitle: "Breakout or Bust!",
      storyLine:
        "<p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful. As guards in the nation's strongest prison, it is your duty to uphold Alcatraz's stalwart reputation.</p><p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful.</p>",
    ...
    gameCardData: {
      ...
      video: {
        webmUrl:
          "/assets/escape-games/videos/webm/superheros-dventure-escape-game.webm",
        url: "/assets/escape-games/videos/mp4/superheros-dventure-escape-game.mp4",
        width: "",
        height: "",
      },
      cardBgImage: {
      ...
      text: "Central City's bank is under attack! As superheroes, you have 60 minutes to stop the Matador, recover his weapon, and save the gold. Coordinate your powers, work as a team, and defeat him before he destroys the city's economy!",
    },
    seoData: {
      metaTitle: "Escape From Alcatraz Escape Room | All In Adventures",
      metaDescription:
  ...
  "houdinis-prestige": {
    ...
    gameCardData: {
      ...
      video: {
        webmUrl:
          "/assets/escape-games/videos/webm/hudinis-prestige-escape-game.webm",
        url: "/assets/escape-games/videos/mp4/hudinis-prestige-escape-game.mp4",
        width: "",
        height: "",
      },
      cardBgImage: {
      ...
      text: "Outperform Houdini in his workshop! Master his challenges in 60 minutes to access his secrets. Prove your magical prowess and become his successor, or fail and leave defeated. Can you outwit the master?",
    },
    seoData: {
      metaTitle: "Escape From Alcatraz Escape Room | All In Adventures",
      metaDescription:
  ...
  "special-agent": {
    ...
    gameInfo: {
      ...
      successRate: "72",
      price: "26.99",
      gameTheme: ["Espionage", "Crime", "Challenging", "High Stakes"],
      recommendFor: ["Team Building"],
      storyLineTitle: "Breakout or Bust!",
      storyLine:
        "<p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful. As guards in the nation's strongest prison, it is your duty to uphold Alcatraz's stalwart reputation.</p><p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful.</p>",
    ...
    gameCardData: {
      ...
      video: {
        webmUrl:
          "/assets/escape-games/videos/webm/special-agent-escape-game.webm",
        url: "/assets/escape-games/videos/mp4/special-agent-escape-game.mp4",
        width: "",
        height: "",
      },
      cardBgImage: {
      ...
      text: "Interpol's releasing the Velvet Glove! You have 60 minutes to prove their identity, recover the stolen Crown of Hildegard, and dismantle their empire. Search the arrest site for evidence before they are released and escape forever!",
    },
    seoData: {
      metaTitle: "Escape From Alcatraz Escape Room | All In Adventures",
      metaDescription:
  ...
  // ======================================================================== this object changed to reels of fortune------------hollywood-premiere
  "hollywood-premiere": {
    id: 9,
    gameType: "Escape Game",
    ...
    gameCardData: {
      ...
      video: {
        webmUrl:
          "/assets/escape-games/videos/webm/reels-of-fortune-escape-game.webm",
        url: "/assets/escape-games/videos/reels-of-fortune-escape-game.mp4",
        width: "",
        height: "",
      },
      cardBgImage: {
      ...
      text: "You're on 'Name That Celebrity!' In 60 minutes, use pop-culture knowledge to solve riddles and identify the hidden star. Explore the set, decipher clues, and win the grand prize to become a game show legend!",
    },
    seoData: {
      metaTitle: "Escape From Alcatraz Escape Room | All In Adventures",
      metaDescription:
  ...
  "reel-of-fortune": {
    ...
    activeAll: true,
    pageHeroData: {
      pageTitle: "Reels of Fortune Escape Room",
      pageSubTitle:
        "<p>You've been captured by a notorious gang of pirates. Prove you're worthy of becoming part of the crew or prepare to walk the plank!</p>",
      heroBgVideo: {
        video: {
    ...
    gameCardData: {
      poster: {
        url: "/assets/escape-games/poster/all-in-adventures-escape-game-reel-of-fortune-poster.jpg",
        alt: "all in adventures escape game reels of fortune poster",
        width: "470",
        height: "560",
      },
      video: {
        webmUrl:
          "/assets/escape-games/videos/webm/reels-of-fortune-escape-game.webm",
        url: "/assets/escape-games/videos/mp4/reels-of-fortune-escape-game.mp4",
        width: "",
        height: "",
      },
      cardBgImage: {
        url: "/assets/escape-games/card-bg/all-in-adventures-hollywood-premiere-card-bg.png",
        alt: "all in adventures escape game reels of fortune bg",
        width: "794",
        height: "509",
      },
      text:
        "You're on " +
        '"Name That Celebrity!" In 60 minutes, use pop-culture knowledge to solve riddles and identify the hidden star. Explore the set, decipher clues, and win the grand prize to become a game show legend!',
    },
    seoData: {
      metaTitle: "Escape From Alcatraz Escape Room | All In Adventures",
      metaDescription:
  ...
  "toymakers-workshop": {
    ...
    slug: "toymakers-workshop",
    activeAll: true,
    pageHeroData: {
      pageTitle: "Toymakers Workshop Escape Room",
      pageSubTitle:
        "<p>You've been captured by a notorious gang of pirates. Prove you're worthy of becoming part of the crew or prepare to walk the plank!</p>",
      heroBgVideo: {
        video: {
      ...
      gameCarouselData: [
        {
          id: 1,
          carouselImage: {
            url: "/assets/escape-games/poster/all-in-adventures-toymakers-workshop-escape-game-poster.jpg",
            alt: "all in adventures escape game escape from alcatraz",
            width: "",
            height: "",
          },
    ...
    gameCardData: {
      poster: {
        url: "/assets/escape-games/poster/all-in-adventures-toymakers-workshop-escape-game-poster.jpg",
        alt: "all in adventures escape game Toymaker's Workshop poster",
        width: "470",
        height: "560",
      },
      video: {
        webmUrl:
          "/assets/escape-games/videos/webm/toymakers-workshop-escape-game.webm",
        url: "/assets/escape-games/videos/mp4/toymakers-workshop-escape-game.mp4",
        width: "",
        height: "",
      },
      cardBgImage: {
        url: "/assets/escape-games/card-bg/all-in-adventures-toymakers-workstation-bg.png",
        alt: "all in adventures escape game Toymaker's Workshop bg",
        width: "794",
        height: "509",
      },
      text:
  ...
  //============================================================================== special games toymakers-workshop-escape-game
  "lost-in-the-jungle": {
    id: 12,
    gameType: "Escape Game",
    ...
    gameCardData: {
      ...
      video: {
        webmUrl:
          "/assets/escape-games/videos/webm/lost-in-the-jungle-escape-game.webm",
        url: "/assets/escape-games/videos/mp4/lost-in-the-jungle-escape-game.mp4",
        width: "",
        height: "",
      },
      cardBgImage: {
      ...
      text: "A make-believe story comes true! Surrounded by bizarre animals and puzzles, you and your friends must pass the game to save humanity.",
    },
    seoData: {
      metaTitle: "Escape From Alcatraz Escape Room | All In Adventures",
      metaDescription:
  ...
  "wizarding-school": {
    ...
    gameInfo: {
      ...
      successRate: "72",
      price: "26.99",
      gameTheme: ["Adventure", "Quirky", "High Tech", "Small Group Friendly"],
      recommendFor: ["Team Building"],
      storyLineTitle: "Breakout or Bust!",
      storyLine:
        "<p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful. As guards in the nation's strongest prison, it is your duty to uphold Alcatraz's stalwart reputation.</p><p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful.</p>",
    ...
    gameCardData: {
      poster: {
        url: "/assets/escape-games/poster/all-in-adventures-escape-game-wizarding-school-poster.jpg",
        alt: "all in adventures escape game wizarding school video poster",
        width: "470",
        height: "560",
      },
      video: {
        webmUrl:
          "/assets/escape-games/videos/webm/wizarding-school-escape-game.webm",
        url: "/assets/escape-games/videos/mp4/wizarding-school-escape-game.mp4",
        width: "",
        height: "",
      },
      cardBgImage: {
      ...
      text: "Admitted to the Wizarding School and trapped in the head wizard's office. Use your magic knowledge to solve puzzles and escape before your house loses points.",
    },
    seoData: {
      metaTitle: "Escape From Alcatraz Escape Room | All In Adventures",
      metaDescription:
...
export const escapeGameRootPageData = [
  // =============================================================="escape-from-alcatraz":
  {
    id: 1,
    gameType: "Escape Game",
    ...
    activeAll: true,
    pageHeroData: {
      pageTitle: "ESCAPE FROM ALCATRAZ",
      pageSubTitle:
        "<p>You are prison guards at Alcatraz and the Warden's keys have gone missing! Can you find them before there is an escape attempt?</p>",
      heroBgImageDesktop: {
        url: "/assets/escape-games/page-hero/escape-from-alcatraz-game-hero.jpg",
        alt: "page hero image for escape from alcatraz escape game at all in adventures",
        width: "1920",
        height: "880",
      },
      heroBgImageMobile: {
    ...
    gameInfo: {
      ...
      storyLine:
        "<p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful. As guards in the nation's strongest prison, it is your duty to uphold Alcatraz's stalwart reputation.</p><p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful.</p>",
      storyLineBgImage: {
        alt: "Escape from Alcatraz escape game storyline",
        url: "/assets/escape-games/storyline/escape-from-alcatraz-all-in-adventures-escape-game.jpg",
        width: 1920,
        height: 1080,
      },
    },
    gallerySectionData: {
      sectionTitle: "ESCAPE ROOM ESCAPE FROM ALCATRAZ GALLERY",
      sectionSubTitle:
        "<p>Discover the excitement and smiles from birthday parties at All In Adventures! Check out real moments of fun, teamwork, and celebration that make every party unforgettable.</p>",
      galleryVideo: {
    ...
    moreEscapeRoomCarouselSectionData: {
      sectionTitle: "More Escape Rooms",
      sectionSubTitle:
        "<p>More than just our Escape Rooms, many of our locations offer other experiences that your group can do as well. Check with your local venue to see what adventures await you!</p>",
    },
    gameCardData: {
      ...
      video: {
        wistiaMediaId: "5gxx2l57ta",
        url: "/assets/escape-games/videos/webm/escape-from-alcatraz-game-card.webm",
        webMUrl:
          "/assets/escape-games/videos/webm/escape-from-alcatraz-game-card.webm",
      },
      gameStateBgImage: {
        url: "/assets/escape-games/game-stat/escape-from-alcatraz-stat-card.png",
        alt: "Escape from Alcatraz stat bg card",
        width: "1000",
        height: "160",
      },
      cardBgImage: {
  ...
  // ==================================================================="treasure-island":
  {
    ...
    gameInfo: {
      ...
      storyLine:
        "<p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful. As guards in the nation's strongest prison, it is your duty to uphold Alcatraz's stalwart reputation.</p><p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful.</p>",
      storyLineBgImage: {
        alt: "Treasure Island escape game storyline",
        url: "/assets/escape-games/storyline/treasure-island-all-in-adventures-escape-game.jpg",
        width: 1920,
        height: 1080,
      },
    },
  ...
  //  ==================================================================="zombie-apocalypse":
  {
    ...
    activeAll: true,
    pageHeroData: {
      pageTitle: "ZOMBIE APOCALYPSE",
      pageSubTitle:
        "<p>You've been captured by a notorious gang of pirates. Prove you're worthy of becoming part of the crew or prepare to walk the plank!</p>",
      heroBgVideo: {
        video: {
          url: "/assets/escape-games/video-bg/zombie-apocalypse.mp4",
        },
        videoScreen: {
          url: "/assets/escape-games/video-bg/all-in-adventure-escape-room-page-hero.jpg",
          alt: "all in adventures escape game Treasure Island page hero",
    ...
    gameInfo: {
      ...
      storyLine:
        "<p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful. As guards in the nation's strongest prison, it is your duty to uphold Alcatraz's stalwart reputation.</p><p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful.</p>",
      storyLineBgImage: {
        alt: "Zombie Apocalypse escape game storyline",
        url: "/assets/escape-games/storyline/zombie-apoclyps-all-in-adventures-escape-game.jpg",
        width: 1920,
        height: 1080,
      },
    },
  ...
  // ==================================================================="sherlocks-library":
  {
    ...
    pageHeroData: {
      ...
      heroBgVideo: {
        video: {
          url: "/assets/escape-games/video-bg/sherlocks-library.mp4",
        },
        videoScreen: {
          url: "/assets/escape-games/video-bg/all-in-adventure-escape-room-page-hero.jpg",
          alt: "all in adventures escape game Treasure Island page hero",
    ...
    gameInfo: {
      ...
      storyLine:
        "<p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful. As guards in the nation's strongest prison, it is your duty to uphold Alcatraz's stalwart reputation.</p><p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful.</p>",
      storyLineBgImage: {
        alt: "Sherlock's Library escape game storyline",
        url: "/assets/escape-games/storyline/sherlocks-library-all-in-adventures-escape-game.jpg",
        width: 1920,
        height: 1080,
      },
    },
  ...
  //==================================================================="black-ops":
  {
    ...
    pageHeroData: {
      ...
      heroBgVideo: {
        video: {
          url: "/assets/escape-games/video-bg/black-ops.mp4",
        },
        videoScreen: {
          url: "/assets/escape-games/video-bg/all-in-adventure-escape-room-page-hero.jpg",
          alt: "all in adventures escape game Treasure Island page hero",
    ...
    gameInfo: {
      ...
      storyLine:
        "<p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful. As guards in the nation's strongest prison, it is your duty to uphold Alcatraz's stalwart reputation.</p><p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful.</p>",
      storyLineBgImage: {
        alt: "Black Ops escape game storyline",
        url: "/assets/escape-games/storyline/black-ops-all-in-adventures-escape-game.jpg",
        width: 1920,
        height: 1080,
      },
    },
  ...
  // ==================================================================="superheros-adventure":
  {
    ...
    pageHeroData: {
      ...
      heroBgVideo: {
        video: {
          url: "/assets/escape-games/video-bg/superheros-adventurs.mp4",
        },
        videoScreen: {
          url: "/assets/escape-games/video-bg/all-in-adventure-escape-room-page-hero.jpg",
          alt: "all in adventures escape game Treasure Island page hero",
    ...
    gameInfo: {
      ...
      storyLine:
        "<p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful. As guards in the nation's strongest prison, it is your duty to uphold Alcatraz's stalwart reputation.</p><p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful.</p>",
      storyLineBgImage: {
        alt: "Superhero's Adventure escape game storyline",
        url: "/assets/escape-games/storyline/superheros-adventure-all-in-adventures-escape-game.jpg",
        width: 1920,
        height: 1080,
      },
    },
  ...
  //=================================================================== "houdinis-prestige":
  {
    ...
    pageHeroData: {
      ...
      heroBgVideo: {
        video: {
          url: "/assets/escape-games/video-bg/houdinis-prestige.mp4",
        },
        videoScreen: {
          url: "/assets/escape-games/video-bg/all-in-adventure-escape-room-page-hero.jpg",
          alt: "all in adventures escape game Treasure Island page hero",
    ...
    gameInfo: {
      ...
      storyLine:
        "<p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful. As guards in the nation's strongest prison, it is your duty to uphold Alcatraz's stalwart reputation.</p><p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful.</p>",
      storyLineBgImage: {
        alt: "Houdinis Prestige escape game storyline",
        url: "/assets/escape-games/storyline/houdinis-prestige-all-in-adventures-escape-game.jpg",
        width: 1920,
        height: 1080,
      },
    },
  ...
  //=================================================================== "special-agent":
  {
    ...
    pageHeroData: {
      ...
      heroBgVideo: {
        video: {
          url: "/assets/escape-games/video-bg/special-agent.mp4",
        },
        videoScreen: {
          url: "/assets/escape-games/video-bg/all-in-adventure-escape-room-page-hero.jpg",
          alt: "all in adventures escape game Treasure Island page hero",
    ...
    gameInfo: {
      ...
      storyLine:
        "<p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful. As guards in the nation's strongest prison, it is your duty to uphold Alcatraz's stalwart reputation.</p><p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful.</p>",
      storyLineBgImage: {
        alt: "Special Agent escape game storyline",
        url: "/assets/escape-games/storyline/special-agent-all-in-adventures-escape-game.jpg",
        width: 1920,
        height: 1080,
      },
    },
  ...
  // ==================================================================="reel-of-fortune":
  {
    ...
    activeAll: true,
    pageHeroData: {
      pageTitle: "REEL OF FORTUNE",
      pageSubTitle:
        "<p>You've been captured by a notorious gang of pirates. Prove you're worthy of becoming part of the crew or prepare to walk the plank!</p>",
      heroBgVideo: {
        video: {
          url: "/assets/escape-games/video-bg/reel-of-fortune.mp4",
        },
        videoScreen: {
          url: "/assets/escape-games/video-bg/all-in-adventure-escape-room-page-hero.jpg",
          alt: "all in adventures escape game Treasure Island page hero",
    ...
    gameInfo: {
      ...
      storyLine:
        "<p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful. As guards in the nation's strongest prison, it is your duty to uphold Alcatraz's stalwart reputation.</p><p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful.</p>",
      storyLineBgImage: {
        alt: "Reel of Fortune escape game storyline",
        url: "/assets/escape-games/storyline/reel-of-fortune-all-in-adventures-escape-game.jpg",
        width: 1920,
        height: 1080,
      },
    },
  ...
  //=================================================================== "lost-in-the-jungle":
  {
    ...
    pageHeroData: {
      ...
      heroBgVideo: {
        video: {
          url: "/assets/escape-games/video-bg/lost-in-the-jungle.mp4",
        },
        videoScreen: {
          url: "/assets/escape-games/video-bg/all-in-adventure-escape-room-page-hero.jpg",
          alt: "all in adventures escape game Treasure Island page hero",
    ...
    gameInfo: {
      ...
      storyLine:
        "<p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful. As guards in the nation's strongest prison, it is your duty to uphold Alcatraz's stalwart reputation.</p><p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful.</p>",
      storyLineBgImage: {
        alt: "Lost in the Jungle escape game storyline",
        url: "/assets/escape-games/storyline/lost-in-the-jungle-all-in-adventures-escape-game.jpg",
        width: 1920,
        height: 1080,
      },
    },
  ...
  //=================================================================== "wizarding-school":
  {
    ...
    activeAll: true,
    pageHeroData: {
      pageTitle: "Wizarding School",
      pageSubTitle:
        "<p>You've been captured by a notorious gang of pirates. Prove you're worthy of becoming part of the crew or prepare to walk the plank!</p>",
      heroBgVideo: {
        video: {
          url: "/assets/escape-games/video-bg/wizarding-school.mp4",
        },
        videoScreen: {
          url: "/assets/escape-games/video-bg/all-in-adventure-escape-room-page-hero.jpg",
          alt: "all in adventures escape game Treasure Island page hero",
    ...
    gameInfo: {
      ...
      storyLine:
        "<p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful. As guards in the nation's strongest prison, it is your duty to uphold Alcatraz's stalwart reputation.</p><p>The federal prison of Alcatraz, surrounded by the waters of San Francisco Bay, housed some of America's most dangerous and notorious felons. Escaping Alcatraz is no easy feat, and the few that have tried were unsuccessful.</p>",
      storyLineBgImage: {
        alt: "Wizarding School escape game storyline",
        url: "/assets/escape-games/storyline/wizarding-school-all-in-adventures-escape-game.jpg",
        width: 1920,
        height: 1080,
      },
    },
...
export const escapeGameRootListPageData = {
  pageHeroData: {
    pageTitle: "20 ESCAPE ROOMS VENUES IN THE U.S.",
    pageSubTitle:
      "<p>#1 Place for fun adventure activities and events with escape games, axe throwing, virtual reality, game show room, beat the seat. Bring your friend & family today.</p>",

    heroBgVideo: {
      video: {
        url: "/assets/home-page/all-in-adventure-hero-bg.mp4",
        alt: "all in adventures escape game escape from alcatraz video",
      },
      videoScreen: {
        url: "/assets/home-page/all-in-adventure-hero-video-poster.jpg",
        alt: "All in adventure escape room hero",
        width: "1676",
        height: "942",
      },
    },
  ...
  escapeGameListSectionData: {
    sectionTitle: "BOOK TOP ESCAPE ROOM REAR YOU",
    sectionSubTitle:
      "<p>We offer a wide range of escape room experiences. Whether you love exciting thrillers, creepy horror, or epic fantasy, there's an unforgettable challenge waiting for you!</p> ",
  },
  otherGameListSectionData: {
    sectionTitle: "OTHER GAMES",
    sectionSubTitle: null,
  },
  faqSectionData: {
    sectionTitle: "FREQUENTLY ASKED QUESTIONS",
    sectionSubTitle:
      "<p>Find answers to common inquiries about our mobile escape room in Raleigh, NC, including pricing, booking, and game details to help plan your unforgettable adventure!</p>",
    faqList: [
      {
        id: 1,
        question: "Can you accommodate large events? ",
        answer:
          "<p>Absolutely! We love hosting large parties and corporate events. While we may not be able to accommodate your entire group into one room, we can set your group up into multiple teams to start all at the same time. Full facility capacity varies, but we have successfully hosted groups as large as several hundred people!</p>",
      },
      {
        id: 2,
        question: "Can you accommodate large events? ",
  ...
  eventCarouselSectionData: {
    sectionTitle: "ESCAPE ROOM EVENTS AND PARTIES",
    sectionSubTitle:
      "<p>Make your next celebration unforgettable. From birthdays to team-building, we've got the perfect party experience for everyone.</p> ",
  },
  seoData: {},
};

export function getEscapeGameRootPageData(activitySlug) {
  let retData = escapeGameRootPageData.find((obj) => obj.slug === activitySlug);
  return retData;
}
