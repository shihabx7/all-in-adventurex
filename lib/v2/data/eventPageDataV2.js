...
export const eventPageDataV2 = {
  "birthday-party": {
    ...
    PageHeroData: {
      ...
      partyRiboon: true,
      description:
        "Pick one of our party packages — private escape room, party room, and optional catering all sorted. Prefer to keep it simple? Book just the game and head to the mall restaurants after. Either way, one booking and zero stress.",
      videoData: {
        videoUrl:
  ...
  "school-events": {
    ...
    PageHeroData: {
      ...
      partyRiboon: false,
      description:
        "Choose from our group packages — each one includes a private escape room, party room, and optional catering all sorted. Prefer to keep it simple? Book just the game and head to a local restaurant after. Either way, one booking and zero planning stress.",
      videoData: {
        videoUrl:
