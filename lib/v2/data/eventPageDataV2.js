...
// All In Adventures, formerly Mystery Room, is a multi-location escape room and game show room destination in the United States. Book your adventure today!
export const eventPageDataV2 = {
  "birthday-party": {
    ...
    PageHeroData: {
      ...
      partyRiboon: true,
      description:
        "Pick one of our [LOC] party packages — private escape room, party room, and optional catering all sorted. Prefer to keep it simple? Book just the game and head to the mall restaurants after. Either way, one booking and zero stress.",
      videoData: {
        videoUrl:
      ...
      ctaBtnLabel: "BOOK A PARTY PACKAGE",
    },
    ...
    CheckOutPartyPackagesData: {
      ...
      descriptionHtml:
        "<p>Every package includes a 1-hour private escape room plus 2 hours in your own private party room — one hour while the group plays, one hour after to celebrate. Non-players and parents are welcome to relax in the party room the whole time.</p>" +
        "<p>Want food handled? Add catering at checkout — pizza, cookie cake, and unlimited drinks ready when your group walks out. Bringing your own? Store-bought food is welcome.</p>" +
        "<p>Book at least 7 days in advance to lock in your date. Cutting it close? Submit an enquiry below and our manager will reach out to make it work.</p>",
      partyPackageInfo: patyPackageInfoList["birthday-party"],
      description:
        "Every package includes a 1-hour private escape room plus 2 hours in your own private party room — one hour while the group plays, one hour after to celebrate. Non-players and parents are welcome to relax in the party room the whole time.",
      contactDefault: {
        phone: "844-502-5546",
    ...
    EventPageEscapeRoomCarouselData: {
      ...
      sectionSubTitle:
        "Not every celebration needs a party room. Book any escape room the same way our regulars do, grab a bite at the mall right after, and call it a perfect birthday. Simple, flexible, no fuss.",
    },
    MobileMysterySectionData: {
      showCardSection: false,
      sectionTitle: "Can't Come to Us? We'll Bring the Adventure to You.",
      descriptionHtml:
        "<p> Our Mobile Mystery option brings the full escape room experience directly to your school — gym, cafeteria, or common area. No buses, no transportation logistics, no off-campus coordination. Same immersive challenge, same skill-building experience, delivered right to your school.<p>" +
        "<p>Perfect for schools with transportation limitations, large student bodies, or any situation where getting off campus isn't an option.<p>",
      ctaBtnText: "ASK ABOUT MOBILE MYSTERY AT YOUR SCHOOL ",
      sectionSubTitle:
    ...
    EventPageGalleryData: {
      title: "THE FACES SAY IT ALL ",
      description:
        "Every photo tells the same story — a group that came in as guests and left with memories they'll talk about for years. This is what birthdays look like at All In Adventures.",
      galleryImages: [
        {
          id: 1,
    ...
    EventPageFaqsData: {
      ...
      eventFaqList: eventFaqListV2["birthday-party"],
    },
  },
  //================================================================================  team building
  "team-building": {
    ...
    PageHeroData: {
      ...
      partyRiboon: false,
      description:
        "Choose from our [LOC] group packages — private escape room, party room, and optional catering all sorted. Celebrating something else? Book just the game and head to the mall restaurants after. Either way, one booking and zero logistics headache.",
      videoData: {
        videoUrl:
      ...
      ctaBtnLabel: "BOOK A GROUP PACKAGE",
    },
    FeedBackTestimonialSliderData: {
    ...
    CheckOutPartyPackagesData: {
      title: "PICK YOUR PACKAGE AND LEAVE THE REST TO US.",
      descriptionHtml:
        "<p>Every package includes a 1-hour private escape room plus 2 hours in your own private room — one hour while the group plays, one hour after to debrief, celebrate, or just let the energy settle. Non-participants and observers are welcome to relax in the room the whole time.</p>" +
        "<p>Want food handled? Add catering at checkout — pizza, cookie cake, and unlimited drinks ready when your group walks out. Bringing your own? Store-bought food is welcome.</p>" +
        "<p>Book at least 7 days in advance to lock in your date. Cutting it close? Submit an enquiry below and our manager will reach out to make it work.</p>",
      partyPackageInfo: patyPackageInfoList["team-building"],
      description:
        "Every package includes a 1-hour private escape room plus 2 hours in your own private room — one hour while the group plays, one hour after to debrief, celebrate, or just let the energy settle. Non-participants and observers are welcome to relax in the room the whole time.",
      contactDefault: {
        phone: "844-502-5546",
        email: "sales@allinadventures.com",
      },
    ...
    EventPageEscapeRoomCarouselData: {
      sectionTitle: "SKIP THE PACKAGE — JUST BOOK THE GAME",
      sectionSubTitle:
        "Not every group event needs the full setup. Book any escape room the same way our regular players do, grab a bite at the mall right after, and call it a great group outing. Simple, flexible, no fuss.",
    },
    MobileMysterySectionData: {
      showCardSection: true,
      sectionTitle: "Can't Come to Us? We'll Bring the Adventure to You.",
      descriptionHtml:
        "<p>Our Mobile Mystery option brings the full escape room experience directly to your office, conference room, or event venue. No travel. No transportation coordination. No logistics headache. Same immersive, high-energy team building challenge — delivered right to your door.</p>" +
        "<p>Perfect for large companies, remote teams coming together for an offsite, or any group that needs the experience brought to them.</p>" +
        "<p>Available at select All In Adventures locations. Contact our events team to check availability in your area.</p>",
      ctaBtnText: "ASK ABOUT MOBILE MYSTERY ",
      sectionSubTitle:
        "Our Mobile Mystery option brings the full escape room experience directly to your office, conference room, or event venue. No travel. No transportation coordination. No logistics headache. Same immersive, high-energy team building challenge — delivered right to your door.",
    },
    EventPageGalleryData: {
      title: "THIS IS WHAT A GREAT GROUP LOOKS LIKE.",
      description:
        "Every photo here is a real team — collaborating, competing against the clock, and walking out with something no conference room, dinner, or rooftop bar ever gave them. This is what group events look like at All In Adventures.",
      galleryImages: [
        {
          id: 1,
          url: "/assets/event-page-v2/corporate-events-and-team-building/team-building-and-group-events-gallery-01.jpg",
          width: 400,
          height: 400,
          alt: "corporate Event team building Page Gallery Image 1",
        },
        {
          url: "/assets/event-page-v2/corporate-events-and-team-building/team-building-and-group-events-gallery-02.jpg",
          width: 400,
          height: 400,
        ...
        {
          id: 3,
          url: "/assets/event-page-v2/corporate-events-and-team-building/team-building-and-group-events-gallery-03.jpg",
          width: 400,
          height: 400,
        ...
        {
          id: 4,
          url: "/assets/event-page-v2/corporate-events-and-team-building/team-building-and-group-events-gallery-04.jpg",
          width: 400,
          height: 400,
        ...
        {
          id: 5,
          url: "/assets/event-page-v2/corporate-events-and-team-building/team-building-and-group-events-gallery-05.jpg",
          width: 400,
          height: 400,
        ...
        {
          id: 6,
          url: "/assets/event-page-v2/corporate-events-and-team-building/team-building-and-group-events-gallery-06.jpg",
          width: 400,
          height: 400,
    ...
    CustomerLoveTestimonialCarouselData: {
      ...
      reviewList: customerReviewList["team-building"],
    },
    EventPageFaqsData: {
      title: "GOT QUESTIONS? WE'VE GOT ANSWERS",
      description:
        "Planning a corporate event or private group outing for the first time? Not sure which package works for your group? We've covered everything below so you can stop wondering and start planning the event your group will actually talk about.",
      eventFaqList: eventFaqListV2["team-building"],
    },
  },
  "school-events": {
    id: 3,
    PageHeroData: {
      ...
      partyRiboon: false,
      description:
        "Choose from our [LOC] group packages — each one includes a private escape room, party room, and optional catering all sorted. Prefer to keep it simple? Book just the game and head to a local restaurant after. Either way, one booking and zero planning stress.",
      videoData: {
        videoUrl:
    ...
    CheckOutPartyPackagesData: {
      ...
      descriptionHtml:
        ...
        "<p><strong>Here's how it works:</strong> your whole group gets a private themed room, 60 minutes on the clock, and one mission — solve the puzzles, crack the clues, and escape together before time runs out. No experience needed. Every student gets a role and every contribution matters.</p>" +
      ...
      partyPackageInfo: patyPackageInfoList["school-events"],
      description:
        "Every package includes a 1-hour private escape room plus 2 hours in your own private room — one hour while the group plays, one hour after for the debrief, celebration, or just letting the energy settle. Teachers and chaperones who aren't playing are welcome to relax in the room the whole time.",
      contactDefault: {
        phone: "844-502-5546",
        email: "sales@allinadventures.com",
      },
    ...
    EventPageEscapeRoomCarouselData: {
      sectionTitle: "SKIP THE PACKAGE — JUST BOOK THE GAME",
      sectionSubTitle:
        "Not every school outing needs the full setup. Book any escape room the same way our regular players do, head to the mall restaurants right after as a group, and call it a great school outing. Simple, flexible, no fuss.",
    },
    MobileMysterySectionData: {
      showCardSection: true,
      sectionTitle: "CAN'T MAKE THE TRIP? WE'LL COME TO YOU.",
      descriptionHtml:
        "<p>Our Mobile Mystery option brings the full escape room experience directly to your school — gym, cafeteria, or common area. No buses, no transportation logistics, no off-campus coordination. Same immersive challenge, same skill-building experience, delivered right to your school.</p>" +
        "<p>Perfect for schools with transportation limitations, large student bodies, or any situation where getting off campus isn't an option.</p>",
      ctaBtnText: "ASK ABOUT MOBILE MYSTERY AT YOUR SCHOOL ",
      sectionSubTitle:
        "Our Mobile Mystery option brings the full escape room experience directly to your school — gym, cafeteria, or common area. No buses, no transportation logistics, no off-campus coordination. Same immersive challenge, same skill-building experience, delivered right to your school.",
    },
    EventPageGalleryData: {
      title: "SEE WHAT HAPPENS WHEN STUDENTS STOP WATCHING AND START DOING.",
      description:
        "Every photo here is a real student group — collaborating, problem-solving, and walking out with something no classroom lesson ever gave them. This is what a great school event looks like at All In Adventures.",
      galleryImages: [
        {
          id: 1,
          url: "/assets/event-page-v2/field-trips-and-school-event/school-event-and-field-trips-gallery-01.jpg",
          width: 520,
          height: 520,
          alt: "Event Page Gallery Image 1",
        },
        {
          url: "/assets/event-page-v2/field-trips-and-school-event/school-event-and-field-trips-gallery-02.jpg",
          width: 520,
          height: 520,
        ...
        {
          id: 3,
          url: "/assets/event-page-v2/field-trips-and-school-event/school-event-and-field-trips-gallery-03.jpg",
          width: 520,
          height: 520,
        ...
        {
          id: 4,
          url: "/assets/event-page-v2/field-trips-and-school-event/school-event-and-field-trips-gallery-04.jpg",
          width: 520,
          height: 520,
        ...
        {
          id: 5,
          url: "/assets/event-page-v2/field-trips-and-school-event/school-event-and-field-trips-gallery-05.jpg",
          width: 520,
          height: 520,
        ...
        {
          id: 6,
          url: "/assets/event-page-v2/field-trips-and-school-event/school-event-and-field-trips-gallery-06.jpg",
          width: 520,
          height: 520,
    ...
    CustomerLoveTestimonialCarouselData: {
      title: "DON'T TAKE OUR WORD FOR IT.",
      description:
        "Teachers, school administrators, and youth group leaders across the country have brought their students to All In Adventures — and they keep coming back. Here's what they had to say.",
      reviewList: customerReviewList["school-events"],
    },
    EventPageFaqsData: {
      title: "GOT QUESTIONS? WE'VE GOT ANSWERS",
      description:
        "Planning a school event or field trip for the first time? Not sure which package works for your group? We've covered everything below so you can get approved, get booked, and get your students through the door.",
      eventFaqList: eventFaqListV2["school-events"],
    },
  },
};
export const eventListPageDataV2 = {
  id: 1,
  PageHeroData: {
    eyeBrewText: "ESCAPE ROOM BIRTHDAY PARTY",
    title: "THE BIRTHDAY PARTY THEY'LL BE TALKING ABOUT ALL YEAR",
    ...
    videoData: {
      videoUrl: "/assets/event-page-v2/birthday/birthday-party-hero-video.mp4",
      videoType: "video/mp4",
      poster: {
        url: "/assets/event-page-v2/birthday/birthday-party-hero-video-poster.jpg",
        width: 800,
  ...
  EventPageGalleryData: {
    ...
    description:
      "Every photo tells the same story — a group that came in as guests and left with memories they'll talk about for years. This is what fun look like at All In Adventures.",
    galleryImages: [
      {
        id: 1,
        url: "/assets/event-page-v2/all-events/All-Event-Gallery-01.webp",
        width: 1000,
        height: 1000,
        alt: "allinadventures event Gallery Image 1",
      },
      {
        id: 2,
        url: "/assets/event-page-v2/all-events/All-Event-Gallery-02.webp",
        width: 1000,
        height: 1000,
        alt: "allinadventures event Gallery Image 2",
      },
      {
        id: 3,
        url: "/assets/event-page-v2/all-events/All-Event-Gallery-03.webp",
        width: 1000,
        height: 1000,
        alt: "allinadventures event Gallery Image 3",
      },
      {
        id: 4,
        url: "/assets/event-page-v2/all-events/All-Event-Gallery-04.webp",
        width: 1000,
        height: 1000,
        alt: "allinadventures event Gallery Image 4",
      },
      {
        id: 5,
        url: "/assets/event-page-v2/all-events/All-Event-Gallery-05.webp",
        width: 1000,
        height: 1000,
        alt: "allinadventures event Gallery Image 5",
      },
      {
        id: 6,
        url: "/assets/event-page-v2/all-events/All-Event-Gallery-06.webp",
        width: 1000,
        height: 1000,
        alt: "allinadventures event Gallery Image 6",
      },
    ],
  },
  CustomerLoveTestimonialCarouselData: {
    title: "WHAT GROUPS SAY ABOUT US",
    description:
      "Over 57,000 guests have shared their All In Adventures experience — corporate teams, friend groups, families, and everything in between. Here's what real groups from across the country had to say.",
    reviewList: customerReviewList["all"],
  },
  EventPageFaqsData: {
    title: "GOT QUESTIONS? WE'VE GOT ANSWERS",
    description:
