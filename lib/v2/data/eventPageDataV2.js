...
export const eventPageDataV2 = {
  ...
  "school-events": {
    ...
    PageHeroData: {
      ...
      partyRiboon: false,
      description:
        "Choose from our 3 group packages — each one includes a private escape room, party room, and optional catering all sorted. Prefer to keep it simple? Book just the game and head to a local restaurant after. Either way, one booking and zero planning stress.",
      videoData: {
        videoUrl:
