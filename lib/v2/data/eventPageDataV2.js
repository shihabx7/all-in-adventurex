...
export const eventPageDataV2 = {
  "birthday-party": {
    ...
    MobileMysterySectionData: {
      ...
      cardText:
        "Perfect for schools with transportation limitations, large student bodies, or any situation where getting off campus isn't an option.",
      cardBtnText: "ASK ABOUT MOBILE MYSTERY AT YOUR SCHOOL ",
    },
  ...
  "team-building": {
    ...
    MobileMysterySectionData: {
      ...
      cardText:
        "Perfect for large companies, remote teams coming together for an offsite, or any group that needs the experience brought to them.",
      cardText2:
        "Available at select All In Adventures locations. Contact our events team to check availability in your area.",
      cardBtnText: "ASK ABOUT MOBILE MYSTERY",
    },
    EventPageGalleryData: {
