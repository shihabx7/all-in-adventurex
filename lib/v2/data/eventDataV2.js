...
export const eventFaqListV2 = {
  ...
  "team-building": [
    ...
    },
    {
      ...
      faqAnswer:"Absolutely. We run multiple rooms simultaneously for groups of any size — 20, 30, 50, and well beyond — so everyone plays at the same time. Contact our events team at 844-502-5546 or sales@allinadventures.com and we'll build a package around your headcount, schedule, and budget."    },
    {
      id: 20,
      faqQuestion: "How do I book a group event?",
      faqAnswer:"Simply select your location, choose your package, and complete your booking online. Catering can be added at checkout. For groups larger than 10, custom packages, Mobile Mystery, or bookings within 7 days, contact our events team directly."    },
    {
      id: 21,

      faqQuestion: "How far in advance should we book?",
      faqAnswer:"At least 7 days in advance to guarantee your preferred date and time online. For larger groups or custom events, the earlier the better — popular dates fill quickly. Need it sooner? Submit an enquiry below and our manager will reach out personally as quickly as possible."    },
    {
      id: 22,
      faqQuestion: "What is your cancellation policy?",
      faqAnswer:"All bookings are final — we do not offer refunds or cancellations. Cancellation Protection is available at checkout for peace of mind — full refund minus an 8% fee if cancelled at least 24 hours before your booking. Most reservations can be rescheduled online through your confirmation email at least 48 hours in advance."    },
    {
      id: 23,

      faqQuestion: "What if we need to reschedule?",
      faqAnswer:"Most bookings can be rescheduled online through your confirmation email at least 48 hours before your event. Need to change within 48 hours? Contact your local store directly and we'll do our best to work something out."    },
    {
      id: 24,
