...
export const eventFaqListDefaultV2 = [
  ...
  },
  {
    ...
    faqAnswer:
      "<p>Absolutely. We regularly host groups of 20, 30, 50, and well beyond. Our events team handles all the details — multiple rooms, custom packages, catering, the works. Call us at<a href='tel:844-502-5546'> 844-502-5546</a> or email sales@allinadventures.com and we'll build the perfect package for your group.</p>",
  },
  {
    id: 16,
...
"Ms. Patricia W."
"5th Grade Teacher"
"I've organized a lot of field trips. This was the first one where I didn't have to manage a single student. They were completely locked in the whole time, working together without being told to, and came out buzzing. My co-teacher and I just looked at each other. This is the one.",

"Mr. Jason T."
"Middle School Social Studies Teacher"
"Getting field trip approval isn't always easy. I used the curriculum connection — Escape From Alcatraz for our history unit — and my principal approved it without a second question. The students made the connection themselves during the debrief. Best money our school has spent on a trip.",

"Mr. David R.",
"STEM Program Coordinator",
"We did Zombie Apocalypse with our after-school STEM group and it was an absolute hit. The kids were talking about the scientific process without even realizing it. Three of them asked if they could write a reflection for extra credit. That has never happened before."

"Mrs. Linda K.",
"PTA President",
"Brought 42 students across four rooms and the staff coordinated every single detail. Every group started on time, the kids came out absolutely buzzing, and the chaperones had a great time too. Our PTA has already voted to make this an annual trip.",

"Ms. Rebecca H."
"3rd Grade Teacher",
"We'd never done an escape room as a school group before and I was nervous it would be too hard for the younger students. The Game Master was incredible — patient, encouraging, and kept every single kid involved. My quietest student was the one who cracked the final clue.",

"Ms. Angela S."
"7th Grade Teacher"
"Booked the catering package and it was absolutely the right call. Coordinating lunch for 35 students on a field trip is usually a nightmare. This time everything was ready when they came out of the rooms. Happy, fed students and zero chaos. Would do it again in a heartbeat.",

"Coach Marcus B.",
"Youth Group Leader",
"I run a youth group and the teenagers — who are notoriously impossible to impress — were competing, laughing, and strategizing from the first minute. Not one phone came out the entire hour. I've already booked next year."
