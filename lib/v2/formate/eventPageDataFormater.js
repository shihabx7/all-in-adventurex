...
export const eventPageDataFormater = {
  ...
  escapeRoomCarouselSectionData: function (data) {
    let newEventData = eventPageDataV2[data.eventSlug];

    let retData = {
      sectionTitle: newEventData.EventPageEscapeRoomCarouselData.sectionTitle,
      sectionSubTitle:
        newEventData.EventPageEscapeRoomCarouselData.sectionSubTitle,
