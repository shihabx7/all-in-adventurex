...
import { eventPageDataV2,eventListPageDataV2 } from "../data/eventPageDataV2";
...
export function eventListPageData() {
  return eventListPageDataV2;
}
export function eventLocListPageData(locationSlug) {
  return eventListPageDataV2;
}
