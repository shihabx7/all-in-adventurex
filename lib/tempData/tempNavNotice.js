...
const gnNotice = {
  showNotice: true,
  source: "gn",
  text: "<p>50% OFF Online Bookings Every Wednesday! Limited time. Excludes federal and school holidays.</p>",
  link: null,
  linkText: null,
...
const locNotice = {
  ...
  "syracuse-ny": {
    showNotice: true,
    text: "<p>Get 50% OFF Online Bookings Every Wednesday! Limited time. Offer excludes mobile escape rooms and all federal and school holidays.</p>",
