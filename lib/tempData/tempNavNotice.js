...
const locNotice = {
  "syracuse-ny": {
    showNotice: true,
    text: "<p>Use code FREEGIFT when booking Reel of Fortune for groups of 4+ for a FREE Movie Night Kit—a $25 value! Valid while supplies last.</p>",
    expireDate: '05-31-2025',
  }
}
