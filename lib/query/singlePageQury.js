...
const assoJob = "&populate[associateJobDetails]=*";
// Careers page index query
export const careerPageQuery =
  apiUrl + "careers-page?" + pageHero + assoJob + seo;
...
// ============================job-openings page query=============v2
export const jobOpeningsQuery =
  apiUrl + "job-openings?populate=*&sort[0]=id:desc&pagination[pageSize]=12";
