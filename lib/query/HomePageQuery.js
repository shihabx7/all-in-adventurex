...
export const LocationListPageListQuery =
  "locations?sort[0]=priority:asc&populate[locationInfo]=*&populate[bookingInfo]=*&populate[locationActivities][populate][activity][populate][activityInfo]=*&populate[pageHeroData][populate][cardImage][fields][0]=name&populate[pageHeroData][populate][cardImage][fields][1]=url&populate[pageHeroData][populate][cardImage][fields][2]=width&populate[pageHeroData][populate][cardImage][fields][3]=height&populate[pageHeroData][populate][cardImage][fields][4]=alternativeText";
