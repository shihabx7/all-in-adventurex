...
const experienceSectionData = (obj) => {
  let retObj = {
    ...
    titleTwo:
      obj.titleTwo !== null
        ? obj.titleTwo
        : "BRING THE ESCAPE ROOM FUN TO YOUR LOCATION",
    descriptionTwo:
      obj.descriptionTwo !== null
        ? obj.descriptionTwo
        : "<p>Our mobile escape room offers a unique and engaging experience, perfect for corporate events, birthday parties, and team-building activities. Tailored to your needs, our exciting themes and challenging puzzles create unforgettable moments that keep your group talking long after the event. Enjoy the fun without leaving your location, as our portable game modules easily set up in various spaces, from outdoor areas to conference rooms.</p><p>Foster teamwork and collaboration in a fun environment with our mobile escape room, enhancing relationships among colleagues and friends. Book your adventure today and let the excitement come to you!</p>",
    imageTwo: getImageData(obj.imageTwo),
  };
  return retObj;
};
  ...
  if (listArr.length > 0) {
    for (let i = 0; i < listArr.length; i++) {
      let testObj = {
        ...
        testimonialImageMobile: getImageData(listArr[i].testimonialImageMobile),
