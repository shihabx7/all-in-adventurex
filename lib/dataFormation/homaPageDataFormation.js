...
export const getEscapeGameCarouselSectionData = (listArr, sectionData) => {
  let fetchEscapeGameList = getGameList(listArr, "Escape Games");
  let retObj = {
    hasGames: fetchEscapeGameList.length > 0 ? true : false,
