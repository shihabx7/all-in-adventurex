...
const getSocialMeta = (metaObj, ftImg) => {
  let retObj = {
    title: false,
    description: false,
    hashTags: false,
  ...
  if (metaObj !== null) {
    ...
    retObj.imageUrl =
      metaObj.image.data !== null
        ? mediaURL + metaObj.image.data.attributes.url
        : mediaURL + ftImg;
  }
  return retObj;
};
...
export const uerRootPageMeta = (urlSlug) => {
  let meataData = {
    /* title:
      seoData.metaTitle != null
        ? seoData.metaTitle
        : "Escape Room Gift Cards - All In Adventures",*/
    title: "Unlimited Escape Room Play Pass - All In Adventures",
    description:
      "Get All In Adventures' Unlimited Play Pass! Choose a $50 Day Pass or $79 Annual Pass and enjoy endless escape room fun. Buy now and start playing!",
    keywords:
      "unlimited escape room play pass, all in adventures membership, escape room membership",
    url: urlSlug
      ? "https://allinadventures.com/" + urlSlug
      : "https://allinadventures.com",
    metaRobot: "all",
    ...
    metaimg:
      "https://allinadventures.com/assets/unlimited-escape-room/all-in-adventures-escape-room-unlimited-play-pass.jpg",

    twitterMeta: {
      title: "Unlimited Escape Room Play Pass - All In Adventures",
      description: false,
      hashTags: "Unlimited_Play_Pass",
      imageUrl:
        "https://allinadventures.com/assets/unlimited-escape-room/all-in-adventures-escape-room-unlimited-play-pass.jpg",
    },
  };
...
export const allInRewardPageMeta = (urlSlug) => {
  let meataData = {
   
    title: "Unlock Your All In Rewards - All In Adventures",
    description:
      "With All In Adventures' ALL IN Rewards, every escape gets you closer to a free room. After you enjoy any 2 paid Escape Room adventures, your 3rd one is on us!",
    keywords:
      "escape room rewards, all in adventures rewards, escape game rewarsds, all in rewards",
    url: urlSlug
      ? "https://allinadventures.com/" + urlSlug
      : "https://allinadventures.com",
    metaRobot: "all",
    ...
    twitterMeta: {
      title: "Unblock Your All in Rewards - All In Adventures",
      description: false,
      hashTags: "All_in_Rewards",
      imageUrl:
        "https://allinadventures.com/assets/unlimited-escape-room/all-in-adventures-escape-room-unlimited-play-pass.jpg",
    },
  };
