    ...
    if (
      ...
      let obj = {
        ...
        description: listArr[i].pageSubTitle
          ...
          : listArr[i].activity.data.attributes.pageHeroData.pageSubTitle,
    ...
    keywords:
      locationListSeo.keywords !== null
        ...
        : "escape rooms and other games in " +
          ...
          ",escape rooms in " +
          locationName,
    url: siteUrl + "/" + locationSlug + "/activities",
    metaRobot: seoData.metaRobots !== null ? seoData.metaRobots : "all",
    structuredData:
      seoData.structuredData !== null ? seoData.structuredData : false,
    canonicalURL:
      locationListSeo.canonicalURL !== null
        ...
        : siteUrl + "/" + locationSlug + "/activities",
    metaindex: true,
    metaimg: mediaURL + seoData.metaImage.data.attributes.url,
