...
const getGameList = (listArr, cat) => {
  ...
  for (let i = 0; i < listArr.length; i++) {
    if (listArr[i].attributes.activityInfo.category == cat && listArr[i].attributes.activitySlug !== "reel-of-fortune") {
      let obj = {
        id: i + 1,
...
export const getPageMeta = (
  ...
  let meataData = {
    ...
    url: siteUrl + "/activities/" + activitySlug,
    ...
    canonicalURL:
      seoData.canonicalURL !== null
        ...
        : siteUrl + "/activities" + activitySlug,
    metaindex: true,
    metaimg:
