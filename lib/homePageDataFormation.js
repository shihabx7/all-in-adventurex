  ...
  for (let i = 0; i < listArr.length; i++) {
    if (listArr[i].attributes.activityInfo.category == cat) {
      let obj = {
        ...
        fromPrice: listArr[i].attributes.activityInfo.price[0].Price,
...
export const getPageMeta = (seoData, ftImg, pageSubTitle, totalLocations) => {
  let meataData = {
    title:
      "All In Adventures | " + totalLocations + " Escape Room Venues in U.S.",
    description:
